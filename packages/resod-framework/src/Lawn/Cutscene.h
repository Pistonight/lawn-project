...
public:
    ...
    bool CanZombieGoInGridSpot(ZombieType theZombieType, int theGridX, int theGridY,
    ...
    /// @brief Finds a valid grid position for placing a street zombie and returns it via output
    /// params
    ...
    void FindPlaceForStreetZombies(ZombieType theZombieType, bool theZombieGrid[5][5], int& thePosX,
                                   int& thePosY);
