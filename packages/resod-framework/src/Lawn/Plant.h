...
public:
    ...
    void PlantInitialize(int theGridX, int theGridY, SeedType theSeedType,
    ...
    void Fire(Zombie* theTargetZombie, int theRow,
    ...
    /// @param theSeedType The Plant's SeedType
    /// @param theImitaterType [OPTIONAL] The actual SeedType if theSeedType ==
    ...
    static SexyString GetNameString(SeedType theSeedType,
    ...
    TodParticleSystem* AddAttachedParticle(int thePosX, int thePosY, int theRenderPosition,
    ...
    void PlayBodyReanim(const char* theTrackName, ReanimLoopType theLoopType, int theBlendTime,
                        float theAnimRate);
