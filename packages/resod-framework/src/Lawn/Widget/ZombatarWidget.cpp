...
Color gMoreColors[18] = {Color(151, 33, 33),   Color(199, 53, 53),   Color(220, 112, 47),
                         Color(251, 251, 172), Color(240, 210, 87),  Color(165, 126, 65),
                         Color(106, 72, 32),   Color(72, 35, 5),     Color(50, 56, 61),
                         Color(0, 0, 0),       Color(197, 239, 239), Color(63, 109, 242),
                         Color(13, 202, 151),  Color(158, 183, 19),  Color(30, 210, 64),
                         Color(225, 65, 230),  Color(128, 47, 204),  Color(255, 255, 255)};
...
ZombatarWidget::ZombatarWidget(LawnApp* theApp) {
    ...
    mBackButton->Resize(278, 528, Sexy::IMAGE_ZOMBATAR_MAINMENUBACK_HIGHLIGHT->mWidth,
                        Sexy::IMAGE_ZOMBATAR_MAINMENUBACK_HIGHLIGHT->mHeight);
    ...
    mViewButton->Resize(65, 472, Sexy::IMAGE_ZOMBATAR_VIEW_BUTTON_HIGHLIGHT->mWidth,
                        Sexy::IMAGE_ZOMBATAR_VIEW_BUTTON_HIGHLIGHT->mHeight);
    ...
    mFinishedButton->Resize(445, 472, Sexy::IMAGE_ZOMBATAR_FINISHED_BUTTON_HIGHLIGHT->mWidth,
                            Sexy::IMAGE_ZOMBATAR_FINISHED_BUTTON_HIGHLIGHT->mHeight);
    ...
    mAvatarBackButton->Resize(385, 345, Sexy::IMAGE_ZOMBATAR_BACK_BUTTON_HIGHLIGHT->mWidth,
                              Sexy::IMAGE_ZOMBATAR_BACK_BUTTON_HIGHLIGHT->mHeight);
    ...
    mNewZombatarButton->Resize(195, 395, Sexy::IMAGE_ZOMBATAR_NEWZOMBIE_BUTTON_HIGHLIGHT->mWidth,
                               Sexy::IMAGE_ZOMBATAR_NEWZOMBIE_BUTTON_HIGHLIGHT->mHeight);
    ...
    mDeleteZombatarButton->Resize(
        337, 145, Sexy::FONT_DWARVENTODCRAFT12->StringWidth(mDeleteZombatarButton->mLabel), 20);
    ...
    mSkinButton->Resize(58, 128, Sexy::IMAGE_ZOMBATAR_SKIN_BUTTON_HIGHLIGHT->mWidth,
                        Sexy::IMAGE_ZOMBATAR_SKIN_BUTTON_HIGHLIGHT->mHeight);
    ...
    mHairButton->Resize(58, 164, Sexy::IMAGE_ZOMBATAR_HAIR_BUTTON_HIGHLIGHT->mWidth,
                        Sexy::IMAGE_ZOMBATAR_HAIR_BUTTON_HIGHLIGHT->mHeight);
    ...
    mFacialHairButton->Resize(58, 200, Sexy::IMAGE_ZOMBATAR_FACIAL_HAIR_BUTTON_HIGHLIGHT->mWidth,
                              Sexy::IMAGE_ZOMBATAR_FACIAL_HAIR_BUTTON_HIGHLIGHT->mHeight);
    ...
    mTidbitsButton->Resize(58, 236, Sexy::IMAGE_ZOMBATAR_TIDBITS_BUTTON_HIGHLIGHT->mWidth,
                           Sexy::IMAGE_ZOMBATAR_TIDBITS_BUTTON_HIGHLIGHT->mHeight);
    ...
    mEyewearButton->Resize(58, 272, Sexy::IMAGE_ZOMBATAR_EYEWEAR_BUTTON_HIGHLIGHT->mWidth,
                           Sexy::IMAGE_ZOMBATAR_EYEWEAR_BUTTON_HIGHLIGHT->mHeight);
    ...
    mClothesButton->Resize(58, 308, Sexy::IMAGE_ZOMBATAR_CLOTHES_BUTTON_HIGHLIGHT->mWidth,
                           Sexy::IMAGE_ZOMBATAR_CLOTHES_BUTTON_HIGHLIGHT->mHeight);
    ...
    mAccessoriesButton->Resize(58, 344, Sexy::IMAGE_ZOMBATAR_ACCESSORY_BUTTON_HIGHLIGHT->mWidth,
                               Sexy::IMAGE_ZOMBATAR_ACCESSORY_BUTTON_HIGHLIGHT->mHeight);
    ...
    mHatsButton->Resize(58, 380, Sexy::IMAGE_ZOMBATAR_HATS_BUTTON_HIGHLIGHT->mWidth,
                        Sexy::IMAGE_ZOMBATAR_HATS_BUTTON_HIGHLIGHT->mHeight);
    ...
    mBackdropsButton->Resize(58, 416, Sexy::IMAGE_ZOMBATAR_BACKDROPS_BUTTON_HIGHLIGHT->mWidth,
                             Sexy::IMAGE_ZOMBATAR_BACKDROPS_BUTTON_HIGHLIGHT->mHeight);
...
void ZombatarWidget::ChangePage(ZombatarPage thePage) {
    ...
    mNextPageButton->mDisabled =
        mState != STATE_AVATAR_CREATION || mSubPage == mMaxSubPages || mPage != PAGE_FACIAL_HAIR;
    mPrevPageButton->mDisabled =
        mState != STATE_AVATAR_CREATION || mSubPage == 0 || mPage != PAGE_FACIAL_HAIR;
}
...
void ZombatarWidget::ChangeState(ZombatarState theState) {
    ...
    mNextButton->mDisabled = mState != STATE_AVATAR_LIST ||
                             (mApp->mPlayerInfo && mApp->mPlayerInfo->mZombatarIndex ==
                                                       mApp->mPlayerInfo->mNumZombatars - 1);
    mPrevButton->mDisabled = mState != STATE_AVATAR_LIST ||
                             (mApp->mPlayerInfo && mApp->mPlayerInfo->mZombatarIndex == 0);
...
void ZombatarWidget::DrawPortraitItem(int theItem, Graphics* g,
                                      const Zombatar& theZombatarInstance) {
    g->PushState();
    ...
    if (anItem.mColor == nullptr)
        ...
        g->SetColor(Color::White);
        g->DrawImage(*anItem.mLine, anItem.mOffsetX + anItem.mColorOffsetX,
                     anItem.mOffsetY + anItem.mColorOffsetY);
    }
    g->PopState();
}
...
void ZombatarWidget::Draw(Graphics* g) {
    ...
    if (mState == STATE_AVATAR_LIST) {
        TodDrawString(g,
                      StrFormat("%d / %d", mApp->mPlayerInfo->mZombatarIndex + 1,
                                mApp->mPlayerInfo->mNumZombatars),
                      221, 161, Sexy::FONT_BRIANNETOD12, Color::White, DS_ALIGN_LEFT);
    ...
    for (int i = 0; i < GetItemCount(mPage) + 1; i++) {
        ...
        g->DrawImage(aBGImage, mItemRects[i],
                     Rect(0, 0, Sexy::IMAGE_ZOMBATAR_ACCESSORY_BG->mWidth,
                          Sexy::IMAGE_ZOMBATAR_ACCESSORY_BG->mHeight));
        if (GetItemCount(mPage) != i) {
            ...
            if (aProcessedIndex >= ZOMBATAR_CLOTHES_1 && aProcessedIndex <= ZOMBATAR_CLOTHES_12) {
                g->PushState();
                g->SetClipRect(mItemRects[i].mX + 8, mItemRects[i].mY + 8,
                               Sexy::IMAGE_ZOMBATAR_ACCESSORY_BG->mWidth - 20,
                               Sexy::IMAGE_ZOMBATAR_ACCESSORY_BG->mHeight - 20);
                g->SetColor(Color(gSkinColors[0].mRed, gSkinColors[0].mGreen, gSkinColors[0].mBlue,
                                  g->mColor.mAlpha));
                float aAnotherScaleX = (float)Sexy::IMAGE_ZOMBATAR_ACCESSORY_BG->mWidth /
                                       Sexy::IMAGE_ZOMBATAR_ZOMBIE_BLANK_SKIN->mWidth;
                float aAnotherScaleY = (float)Sexy::IMAGE_ZOMBATAR_ACCESSORY_BG->mHeight /
                                       Sexy::IMAGE_ZOMBATAR_ZOMBIE_BLANK_SKIN->mHeight;
                TodDrawImageScaledF(g, Sexy::IMAGE_ZOMBATAR_ZOMBIE_BLANK_SKIN,
                                    mItemRects[i].mX - 10, mItemRects[i].mY - 10, aAnotherScaleX,
                                    aAnotherScaleY);
                g->SetColor(Color(255, 255, 255, g->mColor.mAlpha));
                TodDrawImageScaledF(g, Sexy::IMAGE_ZOMBATAR_ZOMBIE_BLANK, mItemRects[i].mX - 10,
                                    mItemRects[i].mY - 10, aAnotherScaleX, aAnotherScaleY);
                g->PopState();
            }
            if (gPortraitItems[aProcessedIndex].mColor != nullptr)
                TodDrawImageScaledF(g, *gPortraitItems[aProcessedIndex].mColor, aPosX, aPosY,
                                    aScaleX, aScaleY);

            TodDrawImageScaledF(g, *gPortraitItems[aProcessedIndex].mLine,
                                aPosX + (gPortraitItems[aProcessedIndex].mColorOffsetX * aScaleX),
                                aPosY + (gPortraitItems[aProcessedIndex].mColorOffsetY * aScaleY),
                                aScaleX, aScaleY);
        }
    ...
    if (mPage == PAGE_SKIN || (aCurrentItemIndex != -1 && gPortraitItems[aItemIndex].mAllowColor)) {
        ...
        for (int i = 0; i < aMaxColor; i++) {
            ...
            if (aCurrentItemColor != i) {
                g->mColor.mAlpha = 66;
                if (mColorRects[i].Contains(mWidgetManager->mLastMouseX,
                                            mWidgetManager->mLastMouseY)) {
                    g->mColor.mAlpha = 127;
                }
            }

            g->DrawImage(i == 17 ? Sexy::IMAGE_ZOMBATAR_COLORPICKER_NONE
                                 : Sexy::IMAGE_ZOMBATAR_COLORPICKER,
                         mColorRects[i],
                         Rect(0, 0, Sexy::IMAGE_ZOMBATAR_COLORPICKER->mWidth,
                              Sexy::IMAGE_ZOMBATAR_COLORPICKER->mHeight));
            g->SetColorizeImages(false);
        }
    } else {
        ...
        if (aCurrentItemIndex == -1)
            TodDrawString(g, "[ZOMBATAR_COLOR_ITEM_NOT_CHOSEN]", 349, 394, Sexy::FONT_BRIANNETOD12,
                          Color(255, 255, 255), DS_ALIGN_CENTER);
        else
            TodDrawString(g, "[ZOMBATAR_COLOR_NOT_APPLICABLE]", 349, 394, Sexy::FONT_BRIANNETOD12,
                          Color(255, 255, 255), DS_ALIGN_CENTER);
    }

    if (mPage == PAGE_SKIN) {
        TodDrawStringWrapped(g, "[ZOMBATAR_START_TEXT]", Rect(145, 185, 420, 120),
                             Sexy::FONT_DWARVENTODCRAFT15, Color(208, 190, 44), DS_ALIGN_CENTER);
    }

    if (mMaxSubPages > 0) {
        TodDrawString(g,
                      StrFormat(TodStringTranslate("[ZOMBATAR_PAGE]").c_str(), mSubPage + 1,
                                mMaxSubPages + 1),
                      348, 441, Sexy::FONT_BRIANNETOD12, Color(0, 0, 0), DS_ALIGN_CENTER);
        g->SetColorizeImages(true);
        g->SetColor(Color::White);
    ...
    if (mState == STATE_CONFIRM_TRANSITION) {
        g->SetColorizeImages(true);
        g->SetColor(Color::White);
        g->mColor.mAlpha = TodAnimateCurve(0, TimeTransitionEnd, mTransitionTimer, 0, 255,
                                           TodCurves::CURVE_LINEAR);
        g->DrawImage(IMAGE_ZOMBATAR_WIDGET_BG, aWidgetX, aWidgetY);
        g->SetColorizeImages(false);

        mFinishedButton->mX = TodAnimateCurve(0, TimeTransitionEnd, mTransitionTimer, 445, 155,
                                              TodCurves::CURVE_LINEAR);
        ...
        g->SetColorizeImages(true);
        g->SetColor(Color::White);
        g->mColor.mAlpha = TodAnimateCurve(0, TimeTransitionEnd, mTransitionTimer, 255, 0,
                                           TodCurves::CURVE_LINEAR);
        g->DrawImage(IMAGE_ZOMBATAR_WIDGET_BG, aWidgetX, aWidgetY);
        g->SetColorizeImages(false);

        mFinishedButton->mX = TodAnimateCurve(0, TimeTransitionEnd, mTransitionTimer, 155, 445,
                                              TodCurves::CURVE_LINEAR);
        ...
        TodDrawString(g, "[ZOMBATAR_FINISHED_WARNING_HEADER]", 305, 185, Sexy::FONT_HOUSEOFTERROR28,
                      Color(254, 227, 0), DS_ALIGN_CENTER);
        TodDrawString(g, "[ZOMBATAR_FINISHED_BUTTON_TEXT]", 195, 335, Sexy::FONT_BRIANNETOD12,
                      Color(255, 255, 255), DS_ALIGN_CENTER);
        TodDrawString(g, "[ZOMBATAR_BACK_BUTTON_TEXT]", 435, 335, Sexy::FONT_BRIANNETOD12,
                      Color(255, 255, 255), DS_ALIGN_CENTER);
        TodDrawStringWrapped(g, "[ZOMBATAR_FINISHED_WARNING_TEXT]", Rect(70, 225, 480, 80),
                             Sexy::FONT_CONTINUUMBOLD14, Color(255, 255, 255), DS_ALIGN_CENTER);
    }
...
void ZombatarWidget::Update() {
    ...
    if (mPage == PAGE_SKIN ||
        (aCurrentItemIndex != -1 &&
         gPortraitItems[ItemTypeOffset(mPage) + aCurrentItemIndex].mAllowColor)) {
        int aMaxColor = 18;
        if (mPage == PAGE_SKIN)
            aMaxColor = 12;
        int aCurrentItemColor = GetPageColorIndex(mPage);
    ...
    if (mHasFocus) {
        if (mViewButton->IsMouseOver() || mBackButton->IsMouseOver() ||
            mFinishedButton->IsMouseOver() || mSkinButton->IsMouseOver() ||
            mHairButton->IsMouseOver() || mFacialHairButton->IsMouseOver() ||
            mTidbitsButton->IsMouseOver() || mEyewearButton->IsMouseOver() ||
            mClothesButton->IsMouseOver() || mAccessoriesButton->IsMouseOver() ||
            mHatsButton->IsMouseOver() || mBackdropsButton->IsMouseOver() ||
            mAvatarBackButton->IsMouseOver() || mNewZombatarButton->IsMouseOver() ||
            mNextButton->IsMouseOver() || mPrevButton->IsMouseOver() ||
            mDeleteZombatarButton->IsMouseOver() || mPrevPageButton->IsMouseOver() ||
...
void ZombatarWidget::MouseUp(int x, int y, int theClickCount) {
    if (mBackButton->IsMouseOver()) {
        ...
        mNextPageButton->mDisabled = mState != STATE_AVATAR_CREATION || mSubPage == mMaxSubPages ||
                                     mPage != PAGE_FACIAL_HAIR;
        mPrevPageButton->mDisabled =
            mState != STATE_AVATAR_CREATION || mSubPage == 0 || mPage != PAGE_FACIAL_HAIR;
        ...
        LawnDialog* aDialog = (LawnDialog*)mApp->DoDialog(
            Dialogs::DIALOG_ZOMBATAR_DELETE, true, "[ZOMBATAR_DELETE_HEADER]",
            "[ZOMBATAR_DELETE_BODY]", "", Dialog::BUTTONS_OK_CANCEL);
        ...
        if (mState == STATE_AVATAR_CREATION) {
            ...
            int aBitsCount = Sexy::IMAGE_ZOMBATAR_BACKGROUND_BLANK->mWidth *
                             Sexy::IMAGE_ZOMBATAR_BACKGROUND_BLANK->mHeight;
            ...
            ImageLib::WriteImage(StrFormat("Zombatar_%d", mApp->mPlayerInfo->mNumZombatars),
                                 &aImage, ".png");
