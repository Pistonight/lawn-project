...
UserDialog::UserDialog(LawnApp* theApp)
    ...
    mListSlider = new Slider(IMAGE_ZOMBATAR_TOS_SLIDER, IMAGE_ZOMBATAR_TOS_SLIDER_THUMB,
                             UserDialog::UserDialog_ListSlider, this);
...
void UserDialog::Resize(int theX, int theY, int theWidth, int theHeight) {
    ...
    mRenameButton->Layout(LayoutFlags::LAY_SameLeft | LayoutFlags::LAY_Above |
                              LayoutFlags::LAY_SameHeight | LayoutFlags::LAY_SameWidth,
                          mLawnYesButton, 0, 0, 0, 0);
    mDeleteButton->Layout(LayoutFlags::LAY_SameLeft | LayoutFlags::LAY_Above |
                              LayoutFlags::LAY_SameHeight | LayoutFlags::LAY_SameWidth,
                          mLawnNoButton, 0, 0, 0, 0);
