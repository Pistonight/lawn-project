...
public:
    ...
    SeedType BeghouledPickSeed(int theGridX, int theGridY, BeghouledBoardState* theBoardState,
    ...
    int BeghouledVerticalMatchLength(int theGridX, int theGridY,
    ...
    int BeghouledHorizontalMatchLength(int theGridX, int theGridY,
                                       BeghouledBoardState* theBoardState);
    ...
    /// @param theGridY The starting grid Y coordinate
    /// @param theBoardState The current Beghouled board state
    void BeghouledRemoveHorizontalMatch(int theGridX, int theGridY,
                                        BeghouledBoardState* theBoardState);
    ...
    /// @param theGridY The starting grid Y coordinate
    /// @param theBoardState The current Beghouled board state
    void BeghouledRemoveVerticalMatch(int theGridX, int theGridY,
                                      BeghouledBoardState* theBoardState);
    ...
    bool BeghouledIsValidMove(int theFromX, int theFromY, int theToX, int theToY,
                              BeghouledBoardState* theBoardState);
    ...
    void ScaryPotterPlacePot(ScaryPotType theScaryPotType, ZombieType theZombieType,
                             SeedType theSeedType, int theCount, TodWeightedGridArray* theGridArray,
    ...
    void ScaryPotterDontPlaceInCol(int theCol, TodWeightedGridArray* theGridArray,
                                   int theGridArrayCount);

    void ScaryPotterFillColumnWithPlant(int theCol, SeedType theSeedType,
    ...
    void BeghouledFlashPlant(int theFlashX, int theFlashY, int theFromX, int theFromY, int theToX,
                             int theToY);

    /// @brief Flash a valid match on the Beghouled board for hint purposes
    void BeghouledFlashAMatch();

    bool BeghouledFlashFromBoardState(BeghouledBoardState* theBoardState, int theFromX,
    ...
    bool BeghouledTwistMoveCausesMatch(int theGridX, int theGridY,
                                       BeghouledBoardState* theBoardState);
    ...
    void BeghouledCreatePlants(BeghouledBoardState* theOldBoardState,
