...
public:
    ...
    void DisplayAdvice(const SexyString& theAdvice, MessageStyle theMessageStyle,
                       AdviceType theHelpIndex);

    /// @brief Start the level
    void StartLevel();
    Plant* AddPlant(int theGridX, int theGridY, SeedType theSeedType,
                    SeedType theImitaterType = SeedType::SEED_NONE);
    ...
    /// @brief Start the level fade-out sequence or go to the next stage in
    /// LastStand/IZombie/Vasebreaker/Survival
    void FadeOutLevel();
    ...
    /// @return True if theGridX and theGridY can form a set of CobCannon Coordinates, false
    /// otherwise
    ...
    std::vector<Zombie*> GetZombiesInRadius(int theRow, int theX, int theY, int theRadius,
    ...
    /// @param theRowRange Max row distance it can check
    /// @param theDamageRangeFlags Damage Flags to filter the Zombies
    void KillAllZombiesInRadius(int theRow, int theX, int theY, int theRadius, int theRowRange,
    ...
    void PutZombieInWave(ZombieType theZombieType, int theWaveNumber,
    ...
    Plant* NewPlant(int theGridX, int theGridY, SeedType theSeedType,
                    SeedType theImitaterType = SeedType::SEED_NONE);
    ...
    void DisplayAdviceAgain(const SexyString& theAdvice, MessageStyle theMessageStyle,
                            AdviceType theHelpIndex);
    ...
    /// @return Number of plants that are of type theSeedType and don't have a Plant on top on the
    /// Board
    ...
    /// @param theSeedType The SeedType to check
    /// @param theSeedType The theImitaterType to check incase theSeedType ==
