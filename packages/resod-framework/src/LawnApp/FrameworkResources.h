...
class Image;
class Font;
Image* ResoddedFrameworkLoadImageById(ResourceManager* theManager, int theId);
void ResoddedFrameworkReplaceImageById(ResourceManager* theManager, int theId, Image* theImage);
