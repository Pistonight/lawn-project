...
bool Sexy::ResoddedFrameworkExtractResourcesByName(ResourceManager* theManager,
                                                   const char* theName) {
    if (strcmp(theName, "LoadingImages") == 0)
...
static void* gResources[] = {
    &IMAGE_SEED_SELECTOR,           &IMAGE_GAMEPAD_CURSOR_FRAME, &IMAGE_GAMEPAD_CURSOR_FRAME_SHADOW,
    &IMAGE_GAMEPAD_SELECTOR_SHADOW, &IMAGE_GAMEPAD_IMAGE_P1,     nullptr};

Image* Sexy::ResoddedFrameworkLoadImageById(ResourceManager* theManager, int theId) {
    return (*((Image**)gResources[theId]) =
                theManager->LoadImage(ResoddedFrameworkGetStringIdById(theId)));
}

void Sexy::ResoddedFrameworkReplaceImageById(ResourceManager* theManager, int theId,
                                             Image* theImage) {
...
const char* Sexy::ResoddedFrameworkGetStringIdById(int theId) {
    ...
    case IMAGE_SEED_SELECTOR_ID:
        return "IMAGE_SEED_SELECTOR";
    case IMAGE_GAMEPAD_CURSOR_FRAME_ID:
        return "IMAGE_GAMEPAD_CURSOR_FRAME";
    case IMAGE_GAMEPAD_CURSOR_FRAME_SHADOW_ID:
        return "IMAGE_GAMEPAD_CURSOR_FRAME_SHADOW";
    case IMAGE_GAMEPAD_SELECTOR_SHADOW_ID:
        return "IMAGE_GAMEPAD_SELECTOR_SHADOW";
    case IMAGE_GAMEPAD_IMAGE_P1_ID:
        return "IMAGE_GAMEPAD_IMAGE_P1";
    default:
        return "";
    }
}