...
public:
    ...
    /// @param theButtonMode Button creation flags
    /// @return The created dialog
    virtual Dialog* DoDialogDelay(int theDialogId, bool isModal, const SexyString& theDialogHeader,
    ...
    /// @param theZombieType [OPTIONAL - ZombieType::ZOMBIE_INVALID] The ZombieType to open the page
    /// on
    AlmanacDialog* DoAlmanacDialog(SeedType theSeedType = SeedType::SEED_NONE,
                                   ZombieType theZombieType = ZombieType::ZOMBIE_INVALID);
    ...
    Reanimation* AddReanimation(float theX, float theY, int theRenderOrder,
    ...
    TodParticleSystem* AddTodParticle(float theX, float theY, int theRenderOrder,
    ...
    int LawnMessageBox(int theDialogId, const SexyString& theHeaderName,
    ...
    static SexyString Pluralize(int theCount, const SexyString& theSingular,
    ...
    /// @brief ??? (Unimplemented)
    void BetaAddFile(std::list<std::string>& theUploadFileList, std::string theFileName,
    ...
    /// @param theTaskWeight ???
    void TraceLoadGroup(const char* theGroupName, int theGroupTime, int theTotalGroupWeigth,
                        int theTaskWeight);
