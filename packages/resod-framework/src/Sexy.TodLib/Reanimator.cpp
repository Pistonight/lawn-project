...
ReanimationParams gLawnReanimationArray[(int)ReanimationType::NUM_REANIMS] = {
    {ReanimationType::REANIM_LOADBAR_SPROUT, "reanim/LoadBar_sprout.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_LOADBAR_ZOMBIEHEAD, "reanim/LoadBar_Zombiehead.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_SODROLL, "reanim/SodRoll.reanim", 0},
    {ReanimationType::REANIM_FINAL_WAVE, "reanim/FinalWave.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    ...
    {ReanimationType::REANIM_READYSETPLANT, "reanim/StartReadySetPlant.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    ...
    {ReanimationType::REANIM_ZOMBIE_CHARRED_GARGANTUAR, "reanim/Zombie_charred_gargantuar.reanim",
     0},
    ...
    {ReanimationType::REANIM_ZOMBIES_WON, "reanim/ZombiesWon.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    ...
    {ReanimationType::REANIM_COFFEEBEAN, "reanim/Coffeebean.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    ...
    {ReanimationType::REANIM_BOSS_ICEBALL, "reanim/Zombie_boss_iceball.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_BOSS_FIREBALL, "reanim/Zombie_boss_fireball.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    ...
    {ReanimationType::REANIM_CRAZY_DAVE, "reanim/CrazyDave.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    ...
    {ReanimationType::REANIM_CREDITS_FOOTBALL, "reanim/Credits_Football.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_JACKBOX, "reanim/Credits_Jackbox.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_SELECTOR_SCREEN, "reanim/SelectorScreen.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS) |
         GetBit((int)ReanimFlags::REANIM_FAST_DRAW_IN_SW_MODE)},
    ...
    {ReanimationType::REANIM_ZENGARDEN_WATERINGCAN, "reanim/ZenGarden_wateringcan.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_ZENGARDEN_FERTILIZER, "reanim/ZenGarden_fertilizer.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_ZENGARDEN_BUGSPRAY, "reanim/ZenGarden_bugspray.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_ZENGARDEN_PHONOGRAPH, "reanim/ZenGarden_phonograph.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_DIAMOND, "reanim/Diamond.reanim", 0},
    {ReanimationType::REANIM_ZOMBIE_HAND, "reanim/Zombie_hand.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    ...
    {ReanimationType::REANIM_TREEOFWISDOM, "reanim/TreeOfWisdom.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_TREEOFWISDOM_CLOUDS, "reanim/TreeOfWisdomClouds.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_TREEOFWISDOM_TREEFOOD, "reanim/TreeFood.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_MAIN, "reanim/Credits_Main.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS) |
         GetBit((int)ReanimFlags::REANIM_FAST_DRAW_IN_SW_MODE)},
    {ReanimationType::REANIM_CREDITS_MAIN2, "reanim/Credits_Main2.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS) |
         GetBit((int)ReanimFlags::REANIM_FAST_DRAW_IN_SW_MODE)},
    {ReanimationType::REANIM_CREDITS_MAIN3, "reanim/Credits_Main3.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS) |
         GetBit((int)ReanimFlags::REANIM_FAST_DRAW_IN_SW_MODE)},
    {ReanimationType::REANIM_ZOMBIE_CREDITS_DANCE, "reanim/Zombie_credits_dance.reanim", 0},
    {ReanimationType::REANIM_CREDITS_STAGE, "reanim/Credits_stage.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_BIGBRAIN, "reanim/Credits_BigBrain.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_FLOWER_PETALS, "reanim/Credits_Flower_petals.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_INFANTRY, "reanim/Credits_Infantry.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_THROAT, "reanim/Credits_Throat.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_CRAZYDAVE, "reanim/Credits_CrazyDave.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_BOSSDANCE, "reanim/Credits_Bossdance.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_ZOMBIE_CREDITS_SCREEN_DOOR, "reanim/Zombie_Credits_Screendoor.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_ZOMBIE_CREDITS_CONEHEAD, "reanim/Zombie_Credits_Conehead.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_ZOMBIEARMY1, "reanim/Credits_ZombieArmy1.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_ZOMBIEARMY2, "reanim/Credits_ZombieArmy2.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_TOMBSTONES, "reanim/Credits_Tombstones.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_SOLARPOWER, "reanim/Credits_SolarPower.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_ANYHOUR, "reanim/Credits_Anyhour.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS) |
         GetBit((int)ReanimFlags::REANIM_FAST_DRAW_IN_SW_MODE)},
    {ReanimationType::REANIM_CREDITS_WEARETHEUNDEAD, "reanim/Credits_WeAreTheUndead.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_CREDITS_DISCOLIGHTS, "reanim/Credits_DiscoLights.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
    {ReanimationType::REANIM_FLAG, "reanim/Zombie_FlagPole.reanim", 0},
    {ReanimationType::REANIM_ZOMBATAR_HEAD, "reanim/zombatar_zombie_head.reanim",
     GetBit((int)ReanimFlags::REANIM_NO_ATLAS)},
};

ReanimatorTransform::ReanimatorTransform()
    : mTransX(DEFAULT_FIELD_PLACEHOLDER), mTransY(DEFAULT_FIELD_PLACEHOLDER),
      mSkewX(DEFAULT_FIELD_PLACEHOLDER), mSkewY(DEFAULT_FIELD_PLACEHOLDER),
      mScaleX(DEFAULT_FIELD_PLACEHOLDER), mScaleY(DEFAULT_FIELD_PLACEHOLDER),
      mFrame(DEFAULT_FIELD_PLACEHOLDER), mAlpha(DEFAULT_FIELD_PLACEHOLDER), mImage(nullptr),
      mFont(nullptr), mText("") {}
...
void ReanimationCreateAtlas(ReanimatorDefinition* theDefinition,
                            ReanimationType theReanimationType) {
    ReanimationParams& aParam = gReanimationParamArray[(int)theReanimationType];
    if (theDefinition->mReanimAtlas != nullptr ||
        TestBit(aParam.mReanimParamFlags, ReanimFlags::REANIM_NO_ATLAS))
        return;
    ...
    if (aDuration > 20 && theReanimationType != ReanimationType::REANIM_NONE)
        TodTraceAndLog("[TodLib] - LOADING:Long atlas '%s' %d ms on %s", aParam.mReanimFileName,
                       aDuration, gGetCurrentLevelName().c_str());
}
...
void Reanimation::ReanimationInitialize(float theX, float theY,
                                        ReanimatorDefinition* theDefinition) {
    ...
    if (theDefinition->mTrackCount != 0) {
        ...
        mTrackInstances =
            (ReanimatorTrackInstance*)FindGlobalAllocator(aItemSize)->Calloc(aItemSize);
...
void Reanimation::GetCurrentTransform(int theTrackIndex, ReanimatorTransform* theTransformCurrent) {
    ...
    if (FloatRoundToInt(theTransformCurrent->mFrame) >= 0 && aTrack->mBlendCounter > 0) {
        ...
        BlendTransform(theTransformCurrent, *theTransformCurrent, aTrack->mBlendTransform,
                       aBlendFactor);
    }
}

void Reanimation::GetTransformAtTime(int theTrackIndex, ReanimatorTransform* theTransform,
    ...
    theTransform->mTransX =
        FloatLerp(aTransBefore.mTransX, aTransAfter.mTransX, theFrameTime->mFraction);
    theTransform->mTransY =
        FloatLerp(aTransBefore.mTransY, aTransAfter.mTransY, theFrameTime->mFraction);
    theTransform->mSkewX =
        FloatLerp(aTransBefore.mSkewX, aTransAfter.mSkewX, theFrameTime->mFraction);
    theTransform->mSkewY =
        FloatLerp(aTransBefore.mSkewY, aTransAfter.mSkewY, theFrameTime->mFraction);
    theTransform->mScaleX =
        FloatLerp(aTransBefore.mScaleX, aTransAfter.mScaleX, theFrameTime->mFraction);
    theTransform->mScaleY =
        FloatLerp(aTransBefore.mScaleY, aTransAfter.mScaleY, theFrameTime->mFraction);
    theTransform->mAlpha =
        FloatLerp(aTransBefore.mAlpha, aTransAfter.mAlpha, theFrameTime->mFraction);
    theTransform->mImage = aTransBefore.mImage;
    theTransform->mFont = aTransBefore.mFont;
    theTransform->mText = aTransBefore.mText;

    if (aTransBefore.mFrame != -1.0f && aTransAfter.mFrame == -1.0f &&
...
void Reanimation::MatrixFromTransform(const ReanimatorTransform& theTransform,
...
void Reanimation::ReanimBltMatrix(Graphics* g, Image* theImage, SexyMatrix3& theTransform,
                                  const Rect& theClipRect, const Color& theColor, int theDrawMode,
                                  const Rect& theSrcRect) {
    if (!gSexyAppBase->Is3DAccelerated() &&
        TestBit(gReanimationParamArray[(int)mReanimationType].mReanimParamFlags,
                (int)ReanimFlags::REANIM_FAST_DRAW_IN_SW_MODE) &&
        FloatApproxEqual(theTransform.m01, 0.0f) && FloatApproxEqual(theTransform.m10, 0.0f) &&
        theTransform.m00 > 0.0f && theTransform.m11 > 0.0f && theColor == Color::White) {
        float aScaleX = theTransform.m00;
        float aScaleY = theTransform.m11;
        int aPosX =
            FloatRoundToInt(theTransform.m02 - aScaleX * theSrcRect.mWidth * 0.5f) - g->mTransX;
        int aPosY =
            FloatRoundToInt(theTransform.m12 - aScaleY * theSrcRect.mHeight * 0.5f) - g->mTransY;
...
bool Reanimation::DrawTrack(Graphics* g, int theTrackIndex, int theRenderGroup,
    ...
    if (mEnableExtraAdditiveDraw) {
        ...
        aExtraAdditiveColor.mAlpha =
            ColorComponentMultiply(mExtraAdditiveColor.mAlpha, aImageAlpha);
    }
    ...
    SexyMatrix3Translation(aMatrix, aTrackInstance->mShakeX + g->mTransX - 0.5f,
    ...
    if (aAtlasImage != nullptr) {
        ...
        theTriangleGroup->AddTriangle(g, aImage, aMatrix, aClipRect, aColor, g->mDrawMode,
                                      aSrcRect);
        if (mEnableExtraAdditiveDraw && !aTrackInstance->mIgnoreExtraAdditiveColor) {
            theTriangleGroup->AddTriangle(g, aImage, aMatrix, aClipRect, aExtraAdditiveColor,
                                          Graphics::DRAWMODE_ADDITIVE, aSrcRect);
        }
        if (mEnableExtraOverlayDraw) {
            theTriangleGroup->AddTriangle(
                g, FilterEffectGetImage(aImage, FilterEffect::FILTER_EFFECT_WHITE), aMatrix,
                aClipRect, aExtraOverlayColor, Graphics::DRAWMODE_NORMAL, aSrcRect);
        }
        ...
        if (mEnableExtraAdditiveDraw) {
            ReanimBltMatrix(g, aImage, aMatrix, aClipRect, aExtraAdditiveColor,
                            Graphics::DRAWMODE_ADDITIVE, aSrcRect);
        }
        if (mEnableExtraOverlayDraw) {
            Image* aOverlayImage = FilterEffectGetImage(aImage, FilterEffect::FILTER_EFFECT_WHITE);
            ReanimBltMatrix(g, aOverlayImage, aMatrix, aClipRect, aExtraOverlayColor,
                            Graphics::DRAWMODE_NORMAL, aSrcRect);
        }
    } else if (aTransform.mFont != nullptr && *aTransform.mText != '\0') {
        ...
        if (mEnableExtraAdditiveDraw) {
            ...
            TodDrawStringMatrix(g, aTransform.mFont, aMatrix, aTransform.mText,
                                aExtraAdditiveColor);
            g->SetDrawMode(aOldMode);
        }
    } else if (aFullScreen) {
...
void Reanimation::GetTrackMatrix(int theTrackIndex, SexyTransform2D& theMatrix) {
    ...
    SexyMatrix3Translation(theMatrix, aTrackInstance->mShakeX - 0.5f,
                           aTrackInstance->mShakeY - 0.5f);
}
...
void Reanimation::AttachToAnotherReanimation(Reanimation* theAttachReanim,
    ...
    AttachReanim(theAttachReanim->GetTrackInstanceByName(theTrackName)->mAttachmentID, this, 0.0f,
                 0.0f);
}
...
AttachEffect* Reanimation::AttachParticleToTrack(const char* theTrackName,
    ...
    return AttachParticle(aTrackInstance->mAttachmentID, theParticleSystem, aPosition.x,
                          aPosition.y);
}
...
void Reanimation::GetFramesForLayer(const char* theTrackName, int& theFrameStart,
                                    int& theFrameCount) {
...
void Reanimation::SetTruncateDisappearingFrames(const char* theTrackName,
                                                bool theTruncateDisappearingFrames) {
    if (theTrackName == nullptr) {
        for (int aTrackIndex = 0; aTrackIndex < mDefinition->mTrackCount; aTrackIndex++)
            mTrackInstances[aTrackIndex].mTruncateDisappearingFrames =
                theTruncateDisappearingFrames;
    } else
        GetTrackInstanceByName(theTrackName)->mTruncateDisappearingFrames =
            theTruncateDisappearingFrames;
}
...
Reanimation* ReanimationHolder::AllocReanimation(float theX, float theY, int theRenderOrder,
                                                 ReanimationType theReanimationType) {
...
void ReanimatorEnsureDefinitionLoaded(ReanimationType theReanimType, bool theIsPreloading) {
    ...
    if (theIsPreloading) {
        ...
        if (gAppHasUsedCheatKeys())
            TodTraceAndLog("[TodLib] - Cheater failed to preload '%s' on %s",
                           aReanimParams->mReanimFileName, gGetCurrentLevelName().c_str());
        else
            TodTraceAndLog("[TodLib] - Non-cheater failed to preload '%s' on %s",
                           aReanimParams->mReanimFileName, gGetCurrentLevelName().c_str());
    }
    ...
    if (aDuration > 100) // (beta only) - report if took too long
        TodTraceAndLog("[TodLib] - LOADING:Long reanim '%s' %d ms on %s",
                       aReanimParams->mReanimFileName, aDuration, gGetCurrentLevelName().c_str());
}
...
bool Reanimation::IsTrackShowing(const char* theTrackName) {
    ...
    return mDefinition->mTracks[aTrackIndex].mTransforms[aFrameTime.mAnimFrameAfterInt].mFrame >=
           0.0f;
}

void Reanimation::ShowOnlyTrack(const char* theTrackName) {
    for (int i = 0; i < mDefinition->mTrackCount; i++) {
        mTrackInstances[i].mRenderGroup = stricmp(mDefinition->mTracks[i].mName, theTrackName) == 0
                                              ? RENDER_GROUP_NORMAL
                                              : RENDER_GROUP_HIDDEN;
    }
}
...
void Reanimation::PropogateColorToAttachments() {
    for (int i = 0; i < mDefinition->mTrackCount; i++)
        AttachmentPropogateColor(mTrackInstances[i].mAttachmentID, mColorOverride,
                                 mEnableExtraAdditiveDraw, mExtraAdditiveColor,
                                 mEnableExtraOverlayDraw, mExtraOverlayColor);
}
...
void Reanimation::PlayReanim(const char* theTrackName, ReanimLoopType theLoopType, int theBlendTime,
                             float theAnimRate) {
    if (theBlendTime > 0)
...
void Reanimation::ParseAttacherTrack(const ReanimatorTransform& theTransform,
    ...
    /* Reanimation Attachment Layer Naming Scheme：attacher__REANIMNAME__TRACKNAME[TAG1][TAG2]…… */
    ...
    if (aTags && aTrackName && (uintptr_t)aTags < (uintptr_t)aTrackName)
        return;
...
void Reanimation::AttacherSynchWalkSpeed(int theTrackIndex, Reanimation* theAttachReanim,
    ...
    while (aPlaceHolderFrameStart > mFrameStart &&
           aTrack->mTransforms[aPlaceHolderFrameStart - 1].mText ==
               aTrack->mTransforms[aPlaceHolderFrameStart].mText)
    ...
    while (aPlaceHolderFrameEnd < mFrameStart + mFrameCount - 1 &&
           aTrack->mTransforms[aPlaceHolderFrameEnd + 1].mText ==
               aTrack->mTransforms[aPlaceHolderFrameEnd].mText)
    ...
    ReanimatorTransform& aTransformGuyStart =
        aGroundTrack->mTransforms[theAttachReanim->mFrameStart];
...
void Reanimation::UpdateAttacherTrack(int theTrackIndex) {
    ...
    if (aAttacherInfo.mReanimName.size() != 0) {
        std::string aReanimFileName =
            StrFormat("reanim/%s.reanim", aAttacherInfo.mReanimName.c_str());
        for (int i = 0; i < gReanimationParamArraySize; i++) {
    ...
    if (aAttachReanim == nullptr || aAttachReanim->mReanimationType != aReanimationType) {
        AttachmentDie(aTrackInstance->mAttachmentID);
        aAttachReanim =
            gEffectSystem->mReanimationHolder->AllocReanimation(0.0f, 0.0f, 0, aReanimationType);
    ...
    if (aAttacherInfo.mTrackName.size() != 0) {
        ...
        aAttachReanim->GetFramesForLayer(aAttacherInfo.mTrackName.c_str(), aAnimFrameStart,
                                         aAnimFrameCount);
        ...
        if (aAttachReanim->mAnimRate == 12.0f &&
            aAttacherInfo.mTrackName.compare("anim_walk") == 0 &&
    ...
    AttachmentPropogateColor(aTrackInstance->mAttachmentID, aColor, mEnableExtraAdditiveDraw,
                             mExtraAdditiveColor, mEnableExtraOverlayDraw, mExtraOverlayColor);
}
