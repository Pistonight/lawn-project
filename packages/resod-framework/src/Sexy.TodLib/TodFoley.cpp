...
FoleyParams gLawnFoleyParamArray[(int)FoleyType::NUM_FOLEY] = {
    ...
    {FoleyType::FOLEY_SUKHBIR,
     ...
     {&Sexy::SOUND_GROAN, &Sexy::SOUND_GROAN2, &Sexy::SOUND_GROAN3, &Sexy::SOUND_GROAN4,
      ...
      &Sexy::SOUND_SUKHBIR3},
     0U},
    {FoleyType::FOLEY_JACKINTHEBOX,
     0.0f,
     {&Sexy::SOUND_JACKINTHEBOX},
     GetBit(FOLEYFLAGS_LOOP) | GetBit(FOLEYFLAGS_ONE_AT_A_TIME) | GetBit(FOLEYFLAGS_MUTE_ON_PAUSE)},
    ...
    {FoleyType::FOLEY_RAIN,
     0.0f,
     {&Sexy::SOUND_RAIN},
     GetBit(FOLEYFLAGS_LOOP) | GetBit(FOLEYFLAGS_MUTE_ON_PAUSE)},
    ...
    {FoleyType::FOLEY_GRAVEBUSTERCHOMP,
     0.0f,
     {&Sexy::SOUND_GRAVEBUSTERCHOMP},
     GetBit(FOLEYFLAGS_MUTE_ON_PAUSE)},
    ...
    {FoleyType::FOLEY_WINMUSIC,
     0.0f,
     {&Sexy::SOUND_WINMUSIC},
     GetBit(FOLEYFLAGS_USES_MUSIC_VOLUME)},
    ...
    {FoleyType::FOLEY_DANCER,
     0.0f,
     {&Sexy::SOUND_DANCER},
     GetBit(FOLEYFLAGS_ONE_AT_A_TIME) | GetBit(FOLEYFLAGS_MUTE_ON_PAUSE)},
