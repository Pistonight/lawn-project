...
uint32_t* OpenGLImage::GetBits() {
    if (mBits == nullptr) {
        ...
        glReadPixels(0, 0, mWidth, mHeight, GL_BGRA, GL_UNSIGNED_BYTE, mBits);
...
void OpenGLImage::ImplDrawLine(double theStartX, double theStartY, double theEndX, double theEndY,
...
void OpenGLImage::ImplDrawLineAA(double theStartX, double theStartY, double theEndX, double theEndY,
                                 const Color& theColor, int theDrawMode) {
...
void OpenGLImage::ImplBlt(Image* theImage, int theX, int theY, const Rect& theSrcRect,
                          const Color& theColor, int theDrawMode) {
...
void OpenGLImage::ImplBltF(Image* theImage, float theX, float theY, const Rect& theSrcRect,
    ...
    if (theClipRect != Rect(0, 0, mWidth, mHeight)) {
        ...
        doScissorFromTLCauseOpenGL(theClipRect.mX, theClipRect.mY, theClipRect.mWidth,
                                   theClipRect.mHeight, mHeight);
    } else
        glDisable(GL_SCISSOR_TEST);
...
void OpenGLImage::ImplBltRotated(Image* theImage, float theX, float theY, const Rect& theSrcRect,
                                 const Rect& theClipRect, const Color& theColor, int theDrawMode,
...
void OpenGLImage::ImplStretchBlt(Image* theImage, const Rect& theDestRect, const Rect& theSrcRect,
                                 const Rect& theClipRect, const Color& theColor, int theDrawMode,
                                 bool fastStretch) {
    MemoryImage* aImg = (MemoryImage*)theImage;
...
void OpenGLImage::ImplBltMatrix(Image* theImage, float x, float y, const SexyMatrix3& theMatrix,
                                const Rect& theClipRect, const Color& theColor, int theDrawMode,
    ...
    glm::vec2 origin = {aWidth * 0.5f,
                        aHeight * 0.5f}; // Matrix Draw calls on Images are centered by default
...
void OpenGLImage::ImplBltTrianglesTex(Image* theTexture, const TriVertex theVertices[][3],
...
void OpenGLImage::ImplBltMirror(Image* theImage, int theX, int theY, const Rect& theSrcRect,
                                const Color& theColor, int theDrawMode) {
    MemoryImage* aImg = (MemoryImage*)theImage;
...
void OpenGLImage::ImplStretchBltMirror(Image* theImage, const Rect& theDestRectOrig,
    ...
    glm::vec2 p2 = {theDestRectOrig.mX + theDestRectOrig.mWidth,
                    theDestRectOrig.mY + theDestRectOrig.mHeight};
...
void OpenGLImage::ImplBltRawTexture(void* theTexture, int theTexWidth, int theTexHeight,
