...
unsigned char gFingerCursorData[] = {
    ...
    ,
...
unsigned char gDraggingCursorData[] = {
    ,
...
SexyAppBase::SexyAppBase() {
    ...
    SetString("NEW_VERSION_BODY", "There is an update available for this product.  Would you like "
                                  "to visit the web site to download it?");
...
SexyAppBase::~SexyAppBase() {
    ...
    if (mUserChanged3DSetting) {
        ...
        {
            if (!Is3DAccelerationRecommended()) // may need to prompt user if he wants to keep 3d
                                                // acceleration on
            {
                if (Is3DAccelerated()) {
                    showedMsgBox = true;
                    ...
                    msgBoxData.title =
                        GetString(
                            ...
                            .c_str();
                    std::string aMessage = (mCompanyName + " " +
                                            GetString("HARDWARE_ACCEL_CONFIRMATION",
    ...
    if (!showedMsgBox && Renderer::gRenderingPreDrawError && !IsScreenSaver()) {
        ...
        SDL_MessageBoxData msgBoxData;
        msgBoxData.flags = SDL_MESSAGEBOX_WARNING;
        std::string anAntiDangle1 = GetString(
            "HARDWARE_ACCEL_NOT_WORKING",
    ...
    if (lParam == 0 && aMap.find(hwnd) == aMap.end()) // record
    {
        ...
        if (!IsIconic(hwnd) && IsWindowVisible(hwnd)) {
            if (GetWindowRect(hwnd, &aRect)) {
                ...
                //				SEXY_TRACE(StrFormat("%s %d - %d %d %d
                //%d",aBuf,aProcessId,aRect.left,aRect.top,aRect.right,aRect.bottom).c_str());
                aMap[hwnd] = aRect;
            }
        }
    } else {
...
void SexyAppBase::WriteDemoBuffer() {
    if (mRecordingDemoBuffer) {
        ...
        if (aFP != NULL) {
            ...
            for (DemoMarkerList::iterator aMarkerItr = mDemoMarkerList.begin();
                 aMarkerItr != mDemoMarkerList.end(); ++aMarkerItr) {
...
bool SexyAppBase::DemoCheckHandle(void* theHandle) {
    ...
    if (mPlayingDemoBuffer)
    {
            ...
            {
                    if ((!gSexyAppBase->mDemoIsShortCmd) && (gSexyAppBase->mDemoCmdNum ==
...
Dialog* SexyAppBase::DoDialog(int theDialogId, bool isModal, const SexyString& theDialogHeader,
    ...
    Dialog* aDialog = NewDialog(theDialogId, isModal, theDialogHeader, theDialogLines,
                                theDialogFooter, theButtonMode);
...
void SexyAppBase::AddDialog(int theDialogId, Dialog* theDialog) {
    ...
    if (theDialog->mWidth == 0) {
        ...
        int aWidth = mWidth / 2;
        theDialog->Resize((mWidth - aWidth) / 2, mHeight / 5, aWidth,
                          theDialog->GetPreferredHeight(aWidth));
    }
...
std::string SexyAppBase::GetProductVersionDLL(const std::string& thePath) {
    ...
    if (aGetFileVersionInfoSizeFunc == NULL) {
        ...
        aGetFileVersionInfoFunc =
            (GetFileVersionInfoFunc)GetProcAddress(gVersionDLL, "GetFileVersionInfoA");
    ...
    if (aSize > 0) {
        ...
        char* aBuffer;
        if (aVerQueryValueFunc(aVersionBuffer, "\\StringFileInfo\\040904B0\\ProductVersion",
                               (void**)&aBuffer, &aSize)) {
...
void SexyAppBase::DumpProgramInfo() {
    ...
    aDumpStream << "<HTML><BODY BGCOLOR=EEEEFF><CENTER><FONT SIZE=+2><B>" << asctime(aTM)
                << "</B></FONT><BR>" << std::endl;
    ...
    while (anItr != mMemoryImageSet.end()) {
        ...
        aMemorySize = aBitsMemory + aSurfaceMemory + aPalletizedMemory + aNativeAlphaMemory +
                      aRLAlphaMemory + aRLAdditiveMemory + aTextureMemory;
    ...
    while (aSortedItr != aSortedImageMap.end()) {
        ...
        aDumpStream << "<TD><A HREF=" << anImageName << "><IMG SRC=" << aThumbName
                    << " WIDTH=" << aThumbWidth << " HEIGHT=" << aThumbHeight << "></A></TD>"
                    << std::endl;
        ...
        aDumpStream << "<TD>"
                    << SexyStringToString(((aBitsMemory != 0)
                                               ? "mBits<BR>" + CommaSeperate(aBitsMemory)
                                               : "&nbsp;"))
                    << "</TD>" << std::endl;
        aDumpStream << "<TD>"
                    ...
                    << "</TD>" << std::endl;
        aDumpStream << "<TD>"
                    << SexyStringToString(((aSurfaceMemory != 0)
        ...
        aDumpStream << "<TD>"
                    << SexyStringToString(((aMemoryImage->mIsVolatile) ? "Volatile" : "&nbsp;"))
                    << "</TD>" << std::endl;
        aDumpStream << "<TD>"
                    << SexyStringToString(((aMemoryImage->mForcedMode) ? "Forced" : "&nbsp;"))
                    << "</TD>" << std::endl;
        aDumpStream << "<TD>"
                    << SexyStringToString(((aMemoryImage->mHasAlpha) ? "HasAlpha" : "&nbsp;"))
                    << "</TD>" << std::endl;
        aDumpStream << "<TD>"
                    << SexyStringToString(((aMemoryImage->mHasTrans) ? "HasTrans" : "&nbsp;"))
                    << "</TD>" << std::endl;
        aDumpStream << "<TD>"
                    << SexyStringToString(
                           ((aNativeAlphaMemory != 0)
                                ? "NativeAlpha<BR>" + CommaSeperate(aNativeAlphaMemory)
                                : "&nbsp;"))
                    << "</TD>" << std::endl;
        aDumpStream << "<TD>"
                    << SexyStringToString(((aRLAlphaMemory != 0)
                                               ? "RLAlpha<BR>" + CommaSeperate(aRLAlphaMemory)
                                               : "&nbsp;"))
                    << "</TD>" << std::endl;
        aDumpStream << "<TD>"
        ...
        ImageLib::WriteImage((GetAppDataFolder() + std::string("_dump\\") + aThumbName).c_str(),
                             &anImageLibImage, ".jpeg");
        ...
        ImageLib::WriteImage((GetAppDataFolder() + std::string("_dump\\") + anImageName).c_str(),
                             &anFullImage, ".png");
    ...
    aDumpStream << "<TD>" << SexyStringToString(CommaSeperate(aTotalMemorySize)) << "</TD>"
                << std::endl;
    aDumpStream << "<TD>" << SexyStringToString(CommaSeperate(aTotalBitsMemory)) << "</TD>"
                << std::endl;
    aDumpStream << "<TD>" << SexyStringToString(CommaSeperate(aTotalPalletizedMemory)) << "</TD>"
                << std::endl;
    aDumpStream << "<TD>" << SexyStringToString(CommaSeperate(aTotalSurfaceMemory)) << "</TD>"
                << std::endl;
    aDumpStream << "<TD>" << SexyStringToString(CommaSeperate(aTotalTextureMemory)) << "</TD>"
                << std::endl;
    aDumpStream << "<TD>&nbsp;</TD>" << std::endl;
    aDumpStream << "<TD>&nbsp;</TD>" << std::endl;
    aDumpStream << "<TD>&nbsp;</TD>" << std::endl;
    aDumpStream << "<TD>&nbsp;</TD>" << std::endl;
    aDumpStream << "<TD>" << SexyStringToString(CommaSeperate(aTotalNativeAlphaMemory)) << "</TD>"
                << std::endl;
    aDumpStream << "<TD>" << SexyStringToString(CommaSeperate(aTotalRLAlphaMemory)) << "</TD>"
                << std::endl;
    aDumpStream << "<TD>" << SexyStringToString(CommaSeperate(aTotalRLAdditiveMemory)) << "</TD>"
                << std::endl;
    aDumpStream << "<TD>&nbsp;</TD>" << std::endl;
...
bool SexyAppBase::RegistryWrite(const std::string& theValueName, JSONRegistryType theType,
                                const uint8_t* theValue, uint32_t theLength) {
    if (mPlayingDemoBuffer) {
        if (mManualShutdown)
            return true;
...
bool SexyAppBase::RegistryWriteString(const std::string& theValueName,
                                      const std::string& theString) {
    return RegistryWrite(theValueName, JSONRegistryType::TYPE_STRING, (uint8_t*)theString.c_str(),
                         theString.length());
}

bool SexyAppBase::RegistryWriteInteger(const std::string& theValueName, int theValue) {
    return RegistryWrite(theValueName, JSONRegistryType::TYPE_INTEGER, (uint8_t*)&theValue,
                         sizeof(int));
}
...
bool SexyAppBase::RegistryWriteData(const std::string& theValueName, const uint8_t* theValue,
                                    uint32_t theLength) {
...
bool SexyAppBase::RegistryRead(const std::string& theValueName, JSONRegistryType* theType,
                               uint8_t* theValue, uint32_t* theLength) {
    return RegistryReadKey(theValueName, theType, theValue, theLength, 0);
}

bool SexyAppBase::RegistryReadKey(const std::string& theValueName, JSONRegistryType* theType,
                                  uint8_t* theValue, uint32_t* theLength, int theKey) {
    std::filesystem::path configPath = GetAppDataFolder() + "/registry.json";
...
bool SexyAppBase::RegistryReadData(const std::string& theKey, uint8_t* theValue,
                                   uint32_t* theLength) {
...
bool SexyAppBase::WriteBytesToFile(const std::string& theFileName, const void* theData,
                                   unsigned long theDataLen) {
    if (mPlayingDemoBuffer) {
        if (mManualShutdown)
            return true;
...
void SexyAppBase::Redraw(Rect* theClipRect) {
    ...
    if (!mRenderer->Redraw(theClipRect)) {
        ...
        if ((mActive || (aTick - aRetryTick > 1000 && mIsPhysWindowed)) && (!mMinimized)) {
            ...
            // Re-check resolution at this point, because we hit here when you change your
            // resolution.
            if ((mWidth >= aMode->w || mHeight >= aMode->h) && mIsWindowed) {
                if (mForceWindowed) {
                    Popup(GetString("PLEASE_SET_COLOR_DEPTH",
...
bool SexyAppBase::DrawDirtyStuff() {
    ...
    if ((drewScreen || (aStartTime - mLastDrawTick >= 1000)) &&
        ...
        if (mShowFPS) {
            ...
            g.DrawImage(gFPSImage, mWidth - gFPSImage->GetWidth() - 10,
                        mHeight - gFPSImage->GetHeight() - 10);

            if (mPlayingDemoBuffer)
                g.DrawImage(gDemoTimeLeftImage, mWidth - gDemoTimeLeftImage->GetWidth() - 10,
                            mHeight - gFPSImage->GetHeight() - gDemoTimeLeftImage->GetHeight() -
                                15);
        }
        ...
        mFPSTime)).c_str()); OutputDebugString(StrFormat("Actual      FPS: %d\r\n", (mFPSFlipCount *
        1000) / max((aTickNow - mFPSStartTick), 1)).c_str()); OutputDebugString(StrFormat("Dirty
...
void SexyAppBase::Popup(const std::string& theString) {
    ...
    if (!mShutdown)
        SDL_ShowSimpleMessageBox(SDL_MESSAGEBOX_ERROR,
                                 GetString("FATAL_ERROR", "FATAL ERROR").c_str(), theString.c_str(),
                                 aInternalWindow);
...
static intptr_t CALLBACK MarkerListDialogProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_INITDIALOG: {
        ...
        MoveWindow(aListBox, 10, 10, aRect.right - aRect.left - 20, aRect.bottom - aRect.top - 20,
                   FALSE);
        for (SexyAppBase::DemoMarkerList::iterator anItr = gSexyAppBase->mDemoMarkerList.begin();
            ...
            int aTotalSeconds =
                (gSexyAppBase->mDemoLength - anItr->second) * gSexyAppBase->mFrameTime / 1000;
            int aSeconds = aTotalSeconds % 60;
            int aMinutes = (aTotalSeconds / 60) % 60;
            int anHours = (aTotalSeconds / 3600);

            SexyString aStr =
                StrFormat("%s (%02d:%02d:%02d)", anItr->first.c_str(), anHours, aMinutes, aSeconds);
            GetTextExtentPoint32(hDCListBox, aStr.c_str(), aStr.length(), &aSize);
            dwExtent = aSize.cx + tm.tmAveCharWidth > (int)dwExtent ? aSize.cx + tm.tmAveCharWidth
                                                                    : (int)dwExtent;
...
static int ListDemoMarkers() {
    ...
    *lpw++ = 0;		 // no creation data
    ...
    GlobalUnlock(hgbl);
    ret = DialogBoxIndirect(gHInstance, (LPDLGTEMPLATE)hgbl, gSexyAppBase->mHWnd,
    (DLGPROC)MarkerListDialogProc); GlobalFree(hgbl);
...
static intptr_t CALLBACK JumpToTimeDialogProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_INITDIALOG: {
            ...
            if (RegOpenKeyExA(HKEY_CURRENT_USER, aKeyName.c_str(), 0, KEY_READ | KEY_WRITE,
    &aGameKey) == ERROR_SUCCESS)
            {
                    char aBuf[1024];
                    DWORD aLength = 1000;
                    DWORD aType = REG_SZ;
                    if (RegQueryValueExA(aGameKey, "DemoJumpTime", 0, &aType, (uint8_t *)aBuf,
    &aLength) == ERROR_SUCCESS)
                    {
                            aBuf[aLength] = 0;
    ...
    case WM_COMMAND:
            if (HIWORD(wParam) == BN_CLICKED)
            {
                    if (LOWORD(wParam) == IDOK)
                    {
                            ...
                            HKEY aGameKey;
                            std::string aKeyName = RemoveTrailingSlash("SOFTWARE\\" +
    gSexyAppBase->mRegKey); if (RegOpenKeyExA(HKEY_CURRENT_USER, aKeyName.c_str(), 0, KEY_READ |
    KEY_WRITE, &aGameKey) == ERROR_SUCCESS)
                            {
                                    RegSetValueExA(aGameKey, "DemoJumpTime", 0, REG_SZ, (const
    uint8_t *)aBuf, strlen(aBuf) + 1); RegCloseKey(aGameKey);
                            }
                            ...
                            gSexyAppBase->mFastForwardToUpdateNum = gSexyAppBase->mDemoLength -
    aNumFrames;
                    }
...
static int DemoJumpToTime() {
    ...
    *lpw++ = 0;			  // no creation data
    ...
    GlobalUnlock(hgbl);
    ret = DialogBoxIndirect(gHInstance, (LPDLGTEMPLATE)hgbl, gSexyAppBase->mHWnd,
    (DLGPROC)JumpToTimeDialogProc); GlobalFree(hgbl);
        ...
        while ((!mShutdown) && (mUpdateCount == mLastDemoUpdateCnt) && (!mDemoBuffer.AtEnd())) {
            if (PrepareDemoCommand(false)) {
                ...
                if (mDemoIsShortCmd) {
                    ...
                    case DEMO_KEY_CHAR: {
                        int sizeMult = (int)mDemoBuffer.ReadNumBits(1, false) +
                                       1; // will be 1 for single, 2 for double
...
bool SexyAppBase::ProcessDeferredMessages(bool singleMessage) {
    ...
    while (mDeferredMessages.size() > 0) {
        ...
        if (mRenderer->mCurrentBackend == RenderingBackend::BACKEND_SDL3 &&
            (anEvent.type == SDL_EVENT_MOUSE_BUTTON_DOWN ||
             anEvent.type == SDL_EVENT_MOUSE_BUTTON_UP || anEvent.type == SDL_EVENT_MOUSE_MOTION)) {
        ...
        if ((mRecordingDemoBuffer) && (!mShutdown)) {
            ...
            case SDL_EVENT_WINDOW_FOCUS_GAINED: {
                ...
                if (theTargetWindow == mWindow->mInternalWindow) {
                    ...
                    mDemoBuffer.WriteNumBits((anEvent.type != SDL_EVENT_WINDOW_FOCUS_LOST) ? 1 : 0,
                                             1);
                }
                break;
            }
        ...
        if (!mPlayingDemoBuffer) {
            ...
            case SDL_EVENT_MOUSE_MOTION:
                if (!gInAssert && !mSEHOccured) {
...
#if SEXY_USE_CONTROLLER
                    if (mUsingGamepad) {
                        // If this is genuine physical mouse movement (SDL flags
                        // SDL_MOUSEMOTION_RELATIVE as relative==true for mouse warp injections),
                        // revert to mouse mode. SDL3 sets event.motion.which == SDL_TOUCH_MOUSEID
                        // for touch/synthetic events.
                        if (anEvent.motion.which != SDL_TOUCH_MOUSEID &&
                            (std::abs(anEvent.motion.xrel) > 2 ||
                             std::abs(anEvent.motion.yrel) > 2)) {
                            mUsingGamepad = false;
                            EnforceCursor();
                        } else {
                    ...
                    if (!(x >= mRenderer->mPresentationRect.mX &&
                          x < mRenderer->mPresentationRect.mX +
                                  mRenderer->mPresentationRect.mWidth &&
                          y >= mRenderer->mPresentationRect.mY &&
                          y < mRenderer->mPresentationRect.mY +
                                  mRenderer->mPresentationRect.mHeight &&
                          x > 0 && y > 0)) {
                        break;
                    }
                    mWidgetManager->RemapMouse(x, y);
            ...
            case SDL_EVENT_WINDOW_RESIZED: {
                ...
                if (mWindow->mInternalWindow == theTargetWindow && !mShutdown) {
                    ...
                    mMinimized =
                        SDL_GetWindowFlags(mWindow->mInternalWindow) & SDL_WINDOW_MINIMIZED;
            ...
            case SDL_EVENT_GAMEPAD_REMOVED: {
                ...
                for (int i = 0; i < MAX_GAMEPADS; i++) {
                    if (mGamepads[i] != nullptr &&
                        mGamepads[i]->GetDeviceID() == anEvent.gdevice.which) {
                        anIdRemoved = i;
                        break;
                    }
                }
...
void SexyAppBase::MakeWindow() {
    ...
    if ((mPlayingDemoBuffer) || (mIsWindowed && !mFullScreenWindow)) {
        if (mSavedWindowedSize.mX != -1) {
            SDL_SetWindowSize(mWindow->mInternalWindow, mSavedWindowedSize.mWidth,
                              mSavedWindowedSize.mHeight);

            SDL_SetWindowPosition(mWindow->mInternalWindow, mSavedWindowedSize.mX,
                                  mSavedWindowedSize.mY);

            mPreferredSize = mSavedWindowedSize;
            mSavedWindowedSize = Rect(-1, -1, -1, -1);
        } else {
            SDL_Rect aUsableBounds{};
            SDL_GetDisplayUsableBounds(SDL_GetDisplayForWindow(mWindow->mInternalWindow),
                                       &aUsableBounds);
...
void SexyAppBase::SwitchScreenMode(bool wantWindowed, bool is3d, bool force) {
    if (mIsWindowed) {
        SDL_GetWindowSize(mWindow->mInternalWindow, &mSavedWindowedSize.mWidth,
                          &mSavedWindowedSize.mHeight);

        SDL_GetWindowPosition(mWindow->mInternalWindow, &mSavedWindowedSize.mX,
                              &mSavedWindowedSize.mY);
    }
        ...
        if (mCursorNum >= NUM_CURSORS || (mCursorImages[mCursorNum] == nullptr) ||
            ...
            if (!mCachedCursors[mCursorNum]) {
                SDL_Surface* aSurface = SDL_CreateSurfaceFrom(
                    mCursorImages[mCursorNum]->mWidth, mCursorImages[mCursorNum]->mHeight,
                ...
                if (doUpdate) {
                    ...
                    if ((!mPlayingDemoBuffer) && (mUpdateMultiplier == 1.0)) {
                        ...
                        if (mVSyncBrokenTestUpdates >=
                            (uint32_t)((1000 + mFrameTime - 1) / mFrameTime)) {
...
void SexyAppBase::HandleCmdLineParam(const std::string& theParamName,
    ...
    if (theParamName == "-play") {
        ...
        mDemoFileName = SexyStringToString(
            StrFormat(StringToSexyString(mDemoPrefix + "%d.dmo").c_str(), aDemoFileNum));
...
Sexy::GPUImage* SexyAppBase::GetImage(const std::string& theFileName, bool commitBits) {
    ...
    anImage->SetBits(aLoadedImage->GetBits(), aLoadedImage->GetWidth(), aLoadedImage->GetHeight(),
                     commitBits);
    anImage->mFilePath = theFileName;
    delete aLoadedImage;
...
Sexy::GPUImage* SexyAppBase::CreateCrossfadeImage(Sexy::Image* theImage1, const Rect& theRect1,
...
void SexyAppBase::ColorizeImage(Image* theImage, const Color& theColor) {
    ...
    if ((theColor.mAlpha <= 255) && (theColor.mRed <= 255) && (theColor.mGreen <= 255) &&
        (theColor.mBlue <= 255)) {
...
GPUImage* SexyAppBase::CreateColorizedImage(Image* theImage, const Color& theColor) {
    ...
    if (aSrcMemoryImage->mColorTable == NULL) {
        ...
        memcpy(anImage->mColorIndices, aSrcMemoryImage->mColorIndices,
               anImage->mWidth * theImage->mHeight);
    }
...
void SexyAppBase::RotateImageHue(Sexy::MemoryImage* theImage, int theDelta) {
    ...
    for (int i = 0; i < aSize; i++) {
        ...
        if (delta != 0) {
            ...
            if (r == maxval)
                h = (g == minval ? 1280 + (((maxval - b) * 256) / delta)
                                 : 256 - (((maxval - g) * 256) / delta));
            else if (g == maxval)
                h = (b == minval ? 256 + (((maxval - r) * 256) / delta)
                                 : 768 - (((maxval - b) * 256) / delta));
            else
                h = (r == minval ? 768 + (((maxval - g) * 256) / delta)
                                 : 1280 - (((maxval - r) * 256) / delta));
...
uint32_t SexyAppBase::RGBToHSL(int r, int g, int b) {
    ...
    if (delta != 0) {
        saturation =
            (delta * 256) / ((luminosity <= 128) ? (minval + maxval) : (512 - maxval - minval));

        if (r == maxval)
            hue = (g == minval ? 1280 + (((maxval - b) * 256) / delta)
                               : 256 - (((maxval - g) * 256) / delta));
        else if (g == maxval)
            hue = (b == minval ? 256 + (((maxval - r) * 256) / delta)
                               : 768 - (((maxval - b) * 256) / delta));
        else
            hue = (r == minval ? 768 + (((maxval - g) * 256) / delta)
                               : 1280 - (((maxval - r) * 256) / delta));
...
void SexyAppBase::HSLToRGB(const uint32_t* theSource, uint32_t* theDest, int theSize) {
    for (int i = 0; i < theSize; i++) {
        ...
        theDest[i] = (src & 0xFF000000) |
                     (HSLToRGB((src & 0xFF), (src >> 8) & 0xFF, (src >> 16) & 0xFF) & 0x00FFFFFF);
    }
}
...
void SexyAppBase::RGBToHSL(const uint32_t* theSource, uint32_t* theDest, int theSize) {
    for (int i = 0; i < theSize; i++) {
        uint32_t src = theSource[i];
        theDest[i] = (src & 0xFF000000) |
                     (RGBToHSL(((src >> 16) & 0xFF), (src >> 8) & 0xFF, (src & 0xFF)) & 0x00FFFFFF);
    }
}
    ...
    if (reinit) {
        ...
        else if (aResult != DDInterface::RESULT_OK)
        {
                Popup(GetString("FAILED_INIT_DIRECTDRAW", "Failed to initialize DirectDraw: ") +
                          StringToSexyString(DDInterface::ResultToString(aResult) + " " +
        mDDInterface->mErrorString)); DoExit(1);
        }*/
...
SharedImageRef SexyAppBase::GetSharedImage(const std::string& theFileName,
                                           const std::string& theVariant, bool* isNew) {
...
void SexyAppBase::CleanSharedImages() {
    ...
    if (mCleanupSharedImages) {
        ...
        //  through the SharedImageRef returned by GetSharedImage, but also by calling
        //  GetSharedImage again with the same params -- so we can have instances where we do the
        //  'final' deref on an image but immediately re-request it via GetSharedImage
        SharedImageMap::iterator aSharedImageItr = mSharedImageMap.begin();
        while (aSharedImageItr != mSharedImageMap.end()) {
            SharedImage* aSharedImage = &aSharedImageItr->second;
