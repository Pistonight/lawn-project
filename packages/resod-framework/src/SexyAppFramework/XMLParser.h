...
class XMLElement {
public:
    enum { TYPE_NONE, TYPE_START, TYPE_END, TYPE_ELEMENT, TYPE_INSTRUCTION, TYPE_COMMENT };
...
public:
    ...
    XMLParamMapIteratorList
        mAttributeIteratorList; // stores attribute iterators in their original order
};
...
protected:
    ...
    bool AddAttribute(XMLElement* theElement, const SexyString& aAttributeKey,
