...
public:
    ...
    bool mHadDoubleClick;  // Used to fix a bug with double clicking to hilite a word after the
                           // widget manager started calling mouse drag before mouse down/up events
    int mCursorPos;
    int mHilitePos;
    int mBlinkAcc;
    int mBlinkDelay;
