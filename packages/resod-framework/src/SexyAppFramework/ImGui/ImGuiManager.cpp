...
#endif
#if SEXY_USE_SDL3_RENDERER
    case RenderingBackend::BACKEND_SDL3: // FIXME ! figure out the SDL_Renderer backend so the
                                         // window can't go past the letterbox
    {
...
void ImGuiManager::Flush() {
    ...
    case RenderingBackend::BACKEND_SDL3: {
        ImGui_ImplSDLRenderer3_RenderDrawData(ImGui::GetDrawData(),
                                              ((SDL3Renderer*)mApp->mRenderer)->mBackendRenderer);
    ...
    case RenderingBackend::BACKEND_SDL3: {
        {
            ...
            ImGui_ImplSDL3_InitForSDLRenderer(mApp->mWindow->mInternalWindow,
                                              aRenderer->mBackendRenderer);
