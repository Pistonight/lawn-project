...
public:
    ...
    ConstSmartPtr(const ConstSmartPtr& theCopy)
        : p((T*)(theCopy ? theCopy.p->CreateRef() : NULL)) {}
    ...
    // Assignment operator.  Release old underlying object if not null.  Add reference to new
    // object.
...
// Helper macro to forward declare reference counted classes along with their smart pointer
// definitions
#define SEXY_PTR_FORWARD(X)                                                                        \
    class X;                                                                                       \
    typedef SmartPtr<X> X##Ptr
#define SEXY_PTR_FORWARDNS(X)                                                                      \
    class X;                                                                                       \
    typedef Sexy::SmartPtr<X> X##Ptr
