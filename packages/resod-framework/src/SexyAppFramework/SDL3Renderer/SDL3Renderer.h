...
public:
    ...
    virtual GPUImage* NewGPUImage() { return new SDL3Image(this); }
    ...
    SDL_FPoint TransformToPoint(float x, float y, const SexyMatrix3& m, float aTransX = 0,
                                float aTransY = 0) {
        SDL_FPoint result;
    ...
    SDL_FPoint RotatePointAroundPivot(const SDL_FPoint point, const SDL_FPoint center,
                                      float angleRad) {
