...
public:
    ...
    void PropogateColor(const Color& theColor, bool theEnableAdditiveColor,
...
AttachEffect* AttachTrail(AttachmentID& theAttachmentID, Trail* theTrail, float theOffsetX,
                          float theOffsetY);
/*inline*/ void AttachmentPropogateColor(AttachmentID& theAttachmentID, const Color& theColor,
...
/*inline*/ void AttachmentUpdateAndSetMatrix(AttachmentID& theAttachmentID,
                                             SexyTransform2D& theMatrix);
...
/*inline*/ void AttachmentDetachCrossFadeParticleType(AttachmentID& theAttachmentID,
                                                      ParticleEffect theParticleEffect,
                                                      const char* theCrossFadeName);
/*inline*/ void AttachmentReanimTypeDie(AttachmentID& theAttachmentID,
