...
#define funcname2additive(t0, t1, t2, t3, t4, t5)                                                  \
    TodDrawTriangle_##t0##_##t1##_##t2##_##t3##_##t4##_##t5##_ADDITIVE
...
#define swap(a, b, type)                                                                           \
    ...
    if (v0->y > v1->y)
        swap(v0, v1, SWHelper::SWVertex*);
    if (v1->y > v2->y)
        swap(v1, v2, SWHelper::SWVertex*);
    if (v0->y > v1->y)
        swap(v0, v1, SWHelper::SWVertex*);
