...
DefField gTrailDefFields[] = {
    ...
    {"MinPointDistance", offsetof(TrailDefinition, mMinPointDistance), DefFieldType::DT_FLOAT,
     nullptr},
    {"TrailFlags", offsetof(TrailDefinition, mTrailFlags), DefFieldType::DT_FLAGS,
     gTrailFlagDefSymbols},
    {"WidthOverLength", offsetof(TrailDefinition, mWidthOverLength), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"WidthOverTime", offsetof(TrailDefinition, mWidthOverTime), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"AlphaOverLength", offsetof(TrailDefinition, mAlphaOverLength), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"AlphaOverTime", offsetof(TrailDefinition, mAlphaOverTime), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"TrailDuration", offsetof(TrailDefinition, mTrailDuration), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
...
DefMap gParticleFieldDefMap = {gParticleFieldDefFields, sizeof(ParticleField),
                               ParticleFieldConstructor};
...
DefField gEmitterDefFields[] = {
    ...
    {"ParticleFlags", offsetof(TodEmitterDefinition, mParticleFlags), DefFieldType::DT_FLAGS,
     gParticleFlagSymbols},
    {"EmitterType", offsetof(TodEmitterDefinition, mEmitterType), DefFieldType::DT_ENUM,
     gEmitterTypeSymbols},
    {"Name", offsetof(TodEmitterDefinition, mName), DefFieldType::DT_STRING, nullptr},
    {"SystemDuration", offsetof(TodEmitterDefinition, mSystemDuration),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"OnDuration", offsetof(TodEmitterDefinition, mOnDuration), DefFieldType::DT_STRING, nullptr},
    {"CrossFadeDuration", offsetof(TodEmitterDefinition, mCrossFadeDuration),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"SpawnRate", offsetof(TodEmitterDefinition, mSpawnRate), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"SpawnMinActive", offsetof(TodEmitterDefinition, mSpawnMinActive),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"SpawnMaxActive", offsetof(TodEmitterDefinition, mSpawnMaxActive),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"SpawnMaxLaunched", offsetof(TodEmitterDefinition, mSpawnMaxLaunched),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"EmitterRadius", offsetof(TodEmitterDefinition, mEmitterRadius), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"EmitterOffsetX", offsetof(TodEmitterDefinition, mEmitterOffsetX),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"EmitterOffsetY", offsetof(TodEmitterDefinition, mEmitterOffsetY),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"EmitterBoxX", offsetof(TodEmitterDefinition, mEmitterBoxX), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"EmitterBoxY", offsetof(TodEmitterDefinition, mEmitterBoxY), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"EmitterPath", offsetof(TodEmitterDefinition, mEmitterPath), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"EmitterSkewX", offsetof(TodEmitterDefinition, mEmitterSkewX), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"EmitterSkewY", offsetof(TodEmitterDefinition, mEmitterSkewY), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"ParticleDuration", offsetof(TodEmitterDefinition, mParticleDuration),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"SystemRed", offsetof(TodEmitterDefinition, mSystemRed), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"SystemGreen", offsetof(TodEmitterDefinition, mSystemGreen), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"SystemBlue", offsetof(TodEmitterDefinition, mSystemBlue), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"SystemAlpha", offsetof(TodEmitterDefinition, mSystemAlpha), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"SystemBrightness", offsetof(TodEmitterDefinition, mSystemBrightness),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"LaunchSpeed", offsetof(TodEmitterDefinition, mLaunchSpeed), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"LaunchAngle", offsetof(TodEmitterDefinition, mLaunchAngle), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"Field", offsetof(TodEmitterDefinition, mParticleFields), DefFieldType::DT_ARRAY,
     &gParticleFieldDefMap},
    {"SystemField", offsetof(TodEmitterDefinition, mSystemFields), DefFieldType::DT_ARRAY,
     &gParticleFieldDefMap},
    {"ParticleRed", offsetof(TodEmitterDefinition, mParticleRed), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"ParticleGreen", offsetof(TodEmitterDefinition, mParticleGreen), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"ParticleBlue", offsetof(TodEmitterDefinition, mParticleBlue), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"ParticleAlpha", offsetof(TodEmitterDefinition, mParticleAlpha), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"ParticleBrightness", offsetof(TodEmitterDefinition, mParticleBrightness),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"ParticleSpinAngle", offsetof(TodEmitterDefinition, mParticleSpinAngle),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"ParticleSpinSpeed", offsetof(TodEmitterDefinition, mParticleSpinSpeed),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"ParticleScale", offsetof(TodEmitterDefinition, mParticleScale), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"ParticleStretch", offsetof(TodEmitterDefinition, mParticleStretch),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"CollisionReflect", offsetof(TodEmitterDefinition, mCollisionReflect),
     DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"CollisionSpin", offsetof(TodEmitterDefinition, mCollisionSpin), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"ClipTop", offsetof(TodEmitterDefinition, mClipTop), DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"ClipBottom", offsetof(TodEmitterDefinition, mClipBottom), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"ClipLeft", offsetof(TodEmitterDefinition, mClipLeft), DefFieldType::DT_TRACK_FLOAT, nullptr},
    {"ClipRight", offsetof(TodEmitterDefinition, mClipRight), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"AnimationRate", offsetof(TodEmitterDefinition, mAnimationRate), DefFieldType::DT_TRACK_FLOAT,
     nullptr},
    {"", 0x0, DefFieldType::DT_INVALID, nullptr},
};
DefMap gEmitterDefMap = {gEmitterDefFields, sizeof(TodEmitterDefinition),
                         TodEmitterDefinitionConstructor};

DefField gParticleDefFields[] = {{"Emitter", 0x0, DefFieldType::DT_ARRAY, &gEmitterDefMap},
                                 {"", 0x0, DefFieldType::DT_INVALID, nullptr}};
DefMap gParticleDefMap = {gParticleDefFields, sizeof(TodParticleDefinition),
                          TodParticleDefinitionConstructor};
...
DefField gReanimatorTrackDefFields[] = {
    ...
    {"t", offsetof(ReanimatorTrack, mTransforms), DefFieldType::DT_ARRAY,
     &gReanimatorTransformDefMap},
    {"", 0x0, DefFieldType::DT_INVALID, nullptr}};
DefMap gReanimatorTrackDefMap = {gReanimatorTrackDefFields, sizeof(ReanimatorTrack),
                                 ReanimatorTrackConstructor};

DefField gReanimatorDefFields[] = {
    {"track", offsetof(ReanimatorDefinition, mTracks), DefFieldType::DT_ARRAY,
     &gReanimatorTrackDefMap},
    {"fps", offsetof(ReanimatorDefinition, mFPS), DefFieldType::DT_FLOAT, nullptr},
    {"", 0x0, DefFieldType::DT_INVALID, nullptr}};
DefMap gReanimatorDefMap = {gReanimatorDefFields, sizeof(ReanimatorDefinition),
                            ReanimatorDefinitionConstructor};

static DefLoadResPath gDefLoadResPaths[4] = {{"IMAGE_", ""},
                                             {"IMAGE_", "particles/"},
...
bool DefReadFromCacheArray(void*& theReadPtr, DefinitionArrayDef* theArray, DefMap* theDefMap) {
    ...
    if (theArray->mArrayCount ==
        0) // If there are no instances of the class, then there is no need to read them.
        return true;
    ...
    for (int i = 0; i < theArray->mArrayCount; i++) {
        ...
        if (!DefMapReadFromCache(theReadPtr, theDefMap,
                                 element)) // The last parameter represents pData[i].
            return false;
    }
...
bool DefMapReadFromCache(void*& theReadPtr, DefMap* theDefMap, void* theDefinition) {
    for (DefField* aField = theDefMap->mMapFields; *aField->mFieldName != '\0'; aField++) {
        ...
        case DefFieldType::DT_ARRAY:
            aSucceed = DefReadFromCacheArray(theReadPtr, (DefinitionArrayDef*)aDest,
...
uint32_t DefinitionCalcHashDefMap(int aSchemaHash, DefMap* theDefMap,
    ...
    for (DefField* aField = theDefMap->mMapFields; *aField->mFieldName != '\0'; aField++) {
        ...
        case DefFieldType::DT_ARRAY:
            aSchemaHash =
                DefinitionCalcHashDefMap(aSchemaHash, (DefMap*)aField->mExtraData, theProgressMaps);
            break;
        }
    }
    return aSchemaHash;
...
uint32_t DefinitionCalcHash(DefMap* theDefMap) {
    ...
    uint32_t aResult =
        DefinitionCalcHashDefMap(crc32(0L, (Bytef*)Z_NULL, NULL) + 1, theDefMap, aProgressMaps);
    return aResult;
}

void* DefinitionUncompressCompiledBuffer(const CompiledDefinitionHeader* aHeader,
                                         void* theCompressedBuffer, size_t theCompressedBufferSize,
    ...
    int aResult = uncompress(aUncompressedBuffer, (uLongf*)&theCompressedBufferSize,
                             (Bytef*)theCompressedBuffer, sz);
    TOD_ASSERT(aResult == Z_OK);
    TOD_ASSERT(theCompressedBufferSize == aHeader->mUncompressedSize);
    return aUncompressedBuffer;
}

bool DefinitionReadCompiledFile(const SexyString& theCompiledFilePath, DefMap* theDefMap,
                                void* theDefinition) {
    ...
    if (pFile) {
        ...
        if (aCompiledFile.isValid()) {
            ...
            void* anUncompressedData = DefinitionUncompressCompiledBuffer(
                aHeader, aDataPtr, aCompressedSize, theCompiledFilePath);
...
#if SEXY_IS_X86
            bool aResult = LegacyDefinition::DefinitionReadCompiledFile(theCompiledFilePath,
                                                                        theDefMap, theDefinition);
            if (aResult) // If it's an x86 machine, and we find original definitions, load them,
                         // then convert to the format we use currently
            {
                TodTraceAndLog("[TodLib] - Converting a Legacy Compiled Definition: \"%s\" to the "
                               "New Format\n",
                               theCompiledFilePath.c_str());
...
bool IsFileInPakFile(const SexyString& theFilePath) {
    ...
    bool aIsInPak =
        pFile && !pFile->mFP; // The file found and opened by mPakRecordMap.find has a null pointer
                              // mFP (because it was not opened from an actual file).
    if (pFile) {
        p_fclose(pFile);
    }
    return aIsInPak;
...
bool DefinitionReadXMLString(XMLParser* theXmlParser, SexyString& theValue) {
    ...
    if (aXMLElement.mType == XMLElement::TYPE_END) // Processing ends when the end tag is read.
        return true;
    else if (aXMLElement.mType !=
             XMLElement::TYPE_ELEMENT) // Apart from the closing tag, under normal circumstances,
                                       // the content read here should be the defined main text.
    {
    ...
    if (aXMLElement.mType !=
        XMLElement::TYPE_END) // Normally, what should be read here is the end tag.
    {
...
bool DefinitionReadArrayField(XMLParser* theXmlParser, DefinitionArrayDef* theArray,
                              DefField* theField) {
    ...
    if (theArray->mArrayCount == 0) {
        ...
        if (theArray->mArrayCount >= 1 &&
            (theArray->mArrayCount == 1 ||
             (theArray->mArrayCount & (theArray->mArrayCount - 1)) == 0)) {
    ...
    if (DefinitionLoadMap(theXmlParser, aDefMap,
                          (unsigned char*)theArray->mArrayData +
                              aDefMap->mDefSize * (theArray->mArrayCount - 1)))
        return true;
    ...
    while (true) {
        ...
        if (aStringChars[anIdx] == '[') {
            ...
            if (aStringChars[anIdx] != ']') {
                ...
                // <curve>
                for (size_t i = 0;
                     i < sizeof(gDefTrackEaseSymbols) / sizeof(gDefTrackEaseSymbols[0]); ++i) {
                    size_t aStrLen = strlen(gDefTrackEaseSymbols[i].mSymbolName);
                    if (strncmp(gDefTrackEaseSymbols[i].mSymbolName, aStringChars + anIdx,
                                aStrLen) == 0) // could be the distribution?
                    {
                        aTrackNode.mDistribution = (TodCurves)gDefTrackEaseSymbols[i].mSymbolValue;
                        anIdx += aStrLen +
                                 1; // Accounts for space (' '), expressions never end with a curve
                        break;
                    }
                }
            ...
            anIdx++;
            // <curve>
            for (size_t i = 0; i < sizeof(gDefTrackEaseSymbols) / sizeof(gDefTrackEaseSymbols[0]);
                 ++i) {
                size_t aStrLen = strlen(gDefTrackEaseSymbols[i].mSymbolName);
...
_m_break:
    ...
    if (theTrack->mCountNodes > 0) {
        ...
        std::memcpy(theTrack->mNodes, aFloatTrackVec.data(),
                    theTrack->mCountNodes * sizeof(FloatParameterTrackNode));
    } else {
...
bool DefinitionReadFlagField(XMLParser* theXmlParser, const SexyString& theElementName,
                             uintptr_t* theResultValue, DefSymbol* theSymbolMap) {
    int aValue;
...
bool DefinitionReadField(XMLParser* theXmlParser, DefMap* theDefMap, void* theDefinition,
    ...
    if (aXMLElement.mType !=
        XMLElement::TYPE_START) // Normally, the start tag should be read here, while other content
                                // is read in subsequent corresponding functions.
    {
    ...
    for (DefField* aField = theDefMap->mMapFields; *aField->mFieldName != '\0'; aField++) {
            ...
            0) // Determine if aXMLElement is defined as the member variable.
        {
            ...
            case DefFieldType::DT_STRING:
                ...
                break;
            case DefFieldType::DT_ENUM:
                aSuccess = DefinitionReadEnumField(theXmlParser, (int*)pVar,
                                                   (DefSymbol*)aField->mExtraData);
                break;
            case DefFieldType::DT_VECTOR2:
            ...
            case DefFieldType::DT_ARRAY:
                aSuccess =
                    DefinitionReadArrayField(theXmlParser, (DefinitionArrayDef*)pVar, aField);
                break;
            case DefFieldType::DT_TRACK_FLOAT:
            ...
            DefinitionXmlError(theXmlParser, "Failed to read '%s' field",
                               aXMLElement.mValue.c_str());
            return false;
        }
    }
    DefinitionXmlError(
        theXmlParser, "Ignoring unknown element '%s'",
...
bool DefinitionLoadMap(XMLParser* theXmlParser, DefMap* theDefMap, void* theDefinition) {
    if (theDefMap->mConstructorFunc)
        ...
        DefinitionFillWithDefaults(
            theDefMap, theDefinition); // TheDefinition is populated with the default value.
...
void DefWriteToCacheArray(DefinitionCompiler* theWritePtr, DefinitionArrayDef* theValue,
                          DefMap* theDefMap) {
    if (theValue == nullptr) {
        theWritePtr->Write(0);
        return;
...
void DefWriteToCacheFloatTrack(DefinitionCompiler* theWritePtr, FloatParameterTrack* theValue) {
    ...
    if (theValue->mCountNodes > 0) {
        theWritePtr->Write(theValue->mNodes,
                           theValue->mCountNodes * sizeof(FloatParameterTrackNode));
    }
}
...
void DefMapWriteToCache(DefinitionCompiler* theWritePtr, DefMap* theDefMap, void* theDefinition) {
    for (DefField* aField = theDefMap->mMapFields; *aField->mFieldName != '\0'; aField++) {
        ...
        case DefFieldType::DT_ARRAY:
            DefWriteToCacheArray(theWritePtr, (DefinitionArrayDef*)aSrc,
                                 (DefMap*)aField->mExtraData);
            break;
...
bool DefinitionWriteCompiledFile(const SexyString& theCompiledFilePath, DefMap* theDefMap,
                                 void* theDefinition) {
...
bool DefinitionCompileFile(const SexyString theXMLFilePath, const SexyString& theCompiledFilePath,
...
bool DefinitionCompileAndLoad(const SexyString& theXMLFilePath, DefMap* theDefMap,
    ...
    bool aResult = DefinitionCompileFile(
        theXMLFilePath, aCompiledFilePath, theDefMap,
    ...
    TodErrorMessageBox(StrFormat("missing resource %s", aCompiledFilePath.c_str()).c_str(),
                       "Error");
    exit(0);
}
...
float FloatTrackEvaluate(FloatParameterTrack& theTrack, float theTimeValue, float theInterp) {
    ...
    if (theTimeValue <
        theTrack.mNodes[0]
            .mTime) // If the current time is less than the start time of the first node
        return TodCurveEvaluate(theInterp, theTrack.mNodes[0].mLowValue,
                                theTrack.mNodes[0].mHighValue, theTrack.mNodes[0].mDistribution);

    for (int i = 1; i < theTrack.mCountNodes; i++) {
        FloatParameterTrackNode* aNodeNxt = &theTrack.mNodes[i];
        if (theTimeValue <=
            aNodeNxt
                ->mTime) // Find the first node whose start time is greater than the current time.
        {
            ...
            float aTimeFraction =
                (theTimeValue - aNodeCur->mTime) / (aNodeNxt->mTime - aNodeCur->mTime);
            float aLeftValue = TodCurveEvaluate(theInterp, aNodeCur->mLowValue,
                                                aNodeCur->mHighValue, aNodeCur->mDistribution);
            float aRightValue = TodCurveEvaluate(theInterp, aNodeNxt->mLowValue,
                                                 aNodeNxt->mHighValue, aNodeNxt->mDistribution);
            return TodCurveEvaluate(aTimeFraction, aLeftValue, aRightValue, aNodeCur->mCurveType);
        }
    }

    FloatParameterTrackNode* aLastNode =
        &theTrack.mNodes[theTrack.mCountNodes -
                         1]; // If the current time is greater than the start time of the last node
    return TodCurveEvaluate(theInterp, aLastNode->mLowValue, aLastNode->mHighValue,
                            aLastNode->mDistribution);
}

void FloatTrackSetDefault(FloatParameterTrack& theTrack, float theValue) {
    if (theTrack.mNodes == nullptr &&
        theValue != 0.0f) // Ensure that this parameter has no nodes (has not been assigned a value)
                          // and that the given default value is not 0.
    {
        theTrack.mCountNodes = 1; // The default parameter track has exactly one node.
        FloatParameterTrackNode* aNode =
            (FloatParameterTrackNode*)DefinitionAlloc(sizeof(FloatParameterTrackNode));
...
bool FloatTrackIsConstantZero(FloatParameterTrack& theTrack) {
    // When a track has no nodes, or has only one node whose maximum and minimum values ​​are
    // both 0, the values ​​on that track are considered to be always zero.
    return theTrack.mCountNodes == 0 ||
           (theTrack.mCountNodes == 1 && theTrack.mNodes[0].mLowValue == 0.0f &&
            theTrack.mNodes[0].mHighValue == 0.0f);
}

float FloatTrackEvaluateFromLastTime(FloatParameterTrack& theTrack, float theTimeValue,
                                     float theInterp) {
...
void DefinitionFreeMap(DefMap* theDefMap, void* theDefinition) {
    ...
    for (DefField* aField = theDefMap->mMapFields; *aField->mFieldName != '\0'; aField++) {
        void* aVar = (void*)((uintptr_t)theDefinition +
                             aField->mFieldOffset); // pointer to this member variable
        switch (aField->mFieldType) {
        case DefFieldType::DT_STRING: {
            char* aStr = *(char**)aVar;
            if (aStr == nullptr)
        ...
        case DefFieldType::DT_TRACK_FLOAT: {
            ...
            if (aCastedField->mCountNodes != 0)
                delete[] aCastedField
                    ->mNodes; // Release the node of the floating-point parameter track
