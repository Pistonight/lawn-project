...
class TodStringListFormat
{
  ...
  public:
	TodStringListFormat();
	TodStringListFormat(const char *theFormatName,
						Sexy::Font **theFont,
...
int TodWriteString(Sexy::Graphics *g,
				   ...
				   int theOffset,
				   int theLength);
/*inline*/ int TodWriteWordWrappedHelper(Sexy::Graphics *g,
										 const SexyString &theString,
										 int theX,
										 int theY,
										 TodStringListFormat &theCurrentFormat,
										 ...
										 int theLength,
										 int theMaxChars);
int TodDrawStringWrappedHelper(Sexy::Graphics *g,
							   ...
							   DrawStringJustification theJustification,
							   bool drawString);
/*inline*/ void TodDrawStringWrapped(Sexy::Graphics *g,
									 const SexyString &theText,
									 const Sexy::Rect &theRect,
									 Sexy::Font *theFont,
									 const Sexy::Color &theColor,
