...
FoleyParams gLawnFoleyParamArray[(int)FoleyType::NUM_FOLEY] = { // 0x69FAD0
    ...
    {FoleyType::FOLEY_SPLAT,
     10.0f,
     {&Sexy::SOUND_SPLAT, &Sexy::SOUND_SPLAT2, &Sexy::SOUND_SPLAT3},
     0U},
    {FoleyType::FOLEY_LAWNMOWER, 10.0f, {&Sexy::SOUND_LAWNMOWER}, 0U},
    {FoleyType::FOLEY_THROW,
     10.0f,
     {&Sexy::SOUND_THROW, &Sexy::SOUND_THROW, &Sexy::SOUND_THROW, &Sexy::SOUND_THROW2},
     0U},
    ...
    {FoleyType::FOLEY_GROAN,
     0.0f,
     {&Sexy::SOUND_GROAN, &Sexy::SOUND_GROAN2, &Sexy::SOUND_GROAN3, &Sexy::SOUND_GROAN4,
      &Sexy::SOUND_GROAN5, &Sexy::SOUND_GROAN6},
     0U},
    {FoleyType::FOLEY_BRAINS,
     0.0f,
     {&Sexy::SOUND_GROAN, &Sexy::SOUND_GROAN2, &Sexy::SOUND_GROAN3, &Sexy::SOUND_GROAN4,
      &Sexy::SOUND_GROAN5, &Sexy::SOUND_GROAN6, &Sexy::SOUND_SUKHBIR4, &Sexy::SOUND_SUKHBIR5,
      &Sexy::SOUND_SUKHBIR6},
     0U},
    {FoleyType::FOLEY_SUKHBIR,
     0.0f,
     {&Sexy::SOUND_GROAN, &Sexy::SOUND_GROAN2, &Sexy::SOUND_GROAN3, &Sexy::SOUND_GROAN4,
      &Sexy::SOUND_GROAN5, &Sexy::SOUND_GROAN6, &Sexy::SOUND_SUKHBIR, &Sexy::SOUND_SUKHBIR2,
      &Sexy::SOUND_SUKHBIR3},
     0U},
    {FoleyType::FOLEY_JACKINTHEBOX, 0.0f, {&Sexy::SOUND_JACKINTHEBOX}, GetBit(FOLEYFLAGS_LOOP) | GetBit(FOLEYFLAGS_ONE_AT_A_TIME) | GetBit(FOLEYFLAGS_MUTE_ON_PAUSE) },
    ...
    {FoleyType::FOLEY_ZOMBIESPLASH,
     10.0f,
     {&Sexy::SOUND_PLANT_WATER, &Sexy::SOUND_ZOMBIE_ENTERING_WATER},
     0U},
    ...
    {FoleyType::FOLEY_ZOMBIE_FALLING,
     10.0f,
     {&Sexy::SOUND_ZOMBIE_FALLING_1, &Sexy::SOUND_ZOMBIE_FALLING_2},
     0U},
    ...
    {FoleyType::FOLEY_DIGGER, 0.0f, {&Sexy::SOUND_DIGGER_ZOMBIE}, GetBit(FOLEYFLAGS_LOOP) | GetBit(FOLEYFLAGS_ONE_AT_A_TIME) | GetBit(FOLEYFLAGS_MUTE_ON_PAUSE)},
    {FoleyType::FOLEY_JACK_SURPRISE,
     1.0f,
     {&Sexy::SOUND_JACK_SURPRISE, &Sexy::SOUND_JACK_SURPRISE, &Sexy::SOUND_JACK_SURPRISE2},
     0U},
    ...
    {FoleyType::FOLEY_IGNITE,
     5.0f,
     {&Sexy::SOUND_IGNITE, &Sexy::SOUND_IGNITE, &Sexy::SOUND_IGNITE, &Sexy::SOUND_IGNITE2},
     0U},
    {FoleyType::FOLEY_FIREPEA, 10.0f, {&Sexy::SOUND_FIREPEA}, 0U},
    {FoleyType::FOLEY_THUMP, 2.0f, {&Sexy::SOUND_GARGANTUAR_THUMP}, 0U},
    {FoleyType::FOLEY_SQUASH_HMM,
     2.0f,
     {&Sexy::SOUND_SQUASH_HMM, &Sexy::SOUND_SQUASH_HMM, &Sexy::SOUND_SQUASH_HMM2},
     0U},
    {FoleyType::FOLEY_MAGNETSHROOM, 2.0f, {&Sexy::SOUND_MAGNETSHROOM}, 0U},
    {FoleyType::FOLEY_BUTTER, 2.0f, {&Sexy::SOUND_BUTTER}, 0U},
    {FoleyType::FOLEY_BUNGEE_SCREAM,
     2.0f,
     {&Sexy::SOUND_BUNGEE_SCREAM, &Sexy::SOUND_BUNGEE_SCREAM2, &Sexy::SOUND_BUNGEE_SCREAM3},
     0U},
    ...
    {FoleyType::FOLEY_RAIN, 0.0f, {&Sexy::SOUND_RAIN}, GetBit(FOLEYFLAGS_LOOP) | GetBit(FOLEYFLAGS_MUTE_ON_PAUSE) },
    ...
    {FoleyType::FOLEY_GRAVEBUSTERCHOMP, 0.0f, {&Sexy::SOUND_GRAVEBUSTERCHOMP}, GetBit(FOLEYFLAGS_MUTE_ON_PAUSE)},
    ...
    {FoleyType::FOLEY_WINMUSIC, 0.0f, {&Sexy::SOUND_WINMUSIC}, GetBit(FOLEYFLAGS_USES_MUSIC_VOLUME)},
    {FoleyType::FOLEY_BALLOONINFLATE, 10.0f, {&Sexy::SOUND_BALLOONINFLATE}, 0U},
    {FoleyType::FOLEY_BIGCHOMP, -2.0f, {&Sexy::SOUND_BIGCHOMP}, 0U},
    {FoleyType::FOLEY_MELONIMPACT,
     -5.0f,
     {&Sexy::SOUND_MELONIMPACT, &Sexy::SOUND_MELONIMPACT2},
     0U},
    ...
    {FoleyType::FOLEY_NEWSPAPER_RARRGH,
     -2.0f,
     {&Sexy::SOUND_NEWSPAPER_RARRGH, &Sexy::SOUND_NEWSPAPER_RARRGH2,
    ...
    {FoleyType::FOLEY_CRAZY_DAVE_SHORT,
     0.0f,
     {&Sexy::SOUND_CRAZYDAVESHORT1, &Sexy::SOUND_CRAZYDAVESHORT2, &Sexy::SOUND_CRAZYDAVESHORT3},
      GetBit(FOLEYFLAGS_DONT_REPEAT)},
    {FoleyType::FOLEY_CRAZY_DAVE_LONG,
     0.0f,
     {&Sexy::SOUND_CRAZYDAVELONG1, &Sexy::SOUND_CRAZYDAVELONG2, &Sexy::SOUND_CRAZYDAVELONG3},
     GetBit(FOLEYFLAGS_DONT_REPEAT)},
    {FoleyType::FOLEY_CRAZY_DAVE_EXTRA_LONG,
     0.0f,
     {&Sexy::SOUND_CRAZYDAVEEXTRALONG1, &Sexy::SOUND_CRAZYDAVEEXTRALONG2,
    ...
    {FoleyType::FOLEY_DANCER, 0.0f, {&Sexy::SOUND_DANCER}, GetBit(FOLEYFLAGS_ONE_AT_A_TIME) | GetBit(FOLEYFLAGS_MUTE_ON_PAUSE)},
...
int TodSoundInstance::GetSoundPosition() {
    float aPosBytes;
    alGetSourcef(mSoundSource, AL_BYTE_OFFSET, &aPosBytes);

    return aPosBytes;
}

void TodSoundInstance::SetSoundPosition(int thePosition) {
    alSourcef(mSoundSource, AL_BYTE_OFFSET, thePosition);
}
...
void SoundSystemReleaseFinishedInstances(TodFoley* theSoundSystem) {
    for (int aFoleyType = 0; aFoleyType < gFoleyParamArraySize; aFoleyType++)
        for (int i = 0; i < MAX_FOLEY_INSTANCES; i++) {
            FoleyInstance* aFoleyInstance =
                &theSoundSystem->mFoleyTypeData[aFoleyType].mFoleyInstances[i];
...
bool SoundSystemHasFoleyPlayedTooRecently(TodFoley* theSoundSystem, FoleyType theFoleyType) {
    ...
    for (int i = 0; i < MAX_FOLEY_INSTANCES; i++) {
        ...
        if (aFoleyInstance->mRefCount != 0 &&
            gSexyAppBase->mUpdateCount - aFoleyInstance->mStartTime < 10)
            return true;
    }
    return false;
}
...
void TodFoley::PlayFoleyPitch(FoleyType theFoleyType, float thePitch) {
    ...
    for (int i = 0; i < 10; i++) {
        if (!TestBit(aFoleyParams->mFoleyFlags, FoleyFlags::FOLEYFLAGS_DONT_REPEAT) ||
            aFoleyData->mLastVariationPlayed != i) {
    ...
    SoundInstance* aSoundInstance =
        gSexyAppBase->mSoundManager->GetSoundInstance(*aFoleyParams->mSfxID[aVariation]);
    ...
    for (int aFoleyType = 0; aFoleyType < gFoleyParamArraySize; aFoleyType++) {
        ...
        if (TestBit(aFoleyParams->mFoleyFlags, FoleyFlags::FOLEYFLAGS_MUTE_ON_PAUSE)) {
            ...
            for (int i = 0; i < MAX_FOLEY_INSTANCES; i++) {
                FoleyInstance* aFoleyInstance = &aFoleyData->mFoleyInstances[i];
                if (aFoleyInstance->mRefCount != 0) {
                    TodSoundInstance* aSoundInstance = (TodSoundInstance*)aFoleyInstance->mInstance;
                    if (theEnteringPause) {
                        aFoleyInstance->mPaused = true;
                        if (aSoundInstance->mSoundSource == AL_NONE) {
...
void TodFoley::ApplyMusicVolume(FoleyInstance* theFoleyInstance) {
    if (gSexyAppBase->mSfxVolume < 1e-6)
        ...
        theFoleyInstance->mInstance->SetVolume(gSexyAppBase->mMusicVolume /
                                               gSexyAppBase->mSfxVolume);
}
